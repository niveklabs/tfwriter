...
```terraform
module "cloudflare_access_group" {
  source = "./modules/cloudflare/r/cloudflare_access_group"
...
output "id" {
  ...
  value       = cloudflare_access_group.this.id
}

output "zone_id" {
  description = "returns a string"
  value       = cloudflare_access_group.this.zone_id
}
