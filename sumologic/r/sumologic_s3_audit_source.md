...
```terraform
module "sumologic_s3_audit_source" {
  source = "./modules/sumologic/r/sumologic_s3_audit_source"
...
```terraform
resource "sumologic_s3_audit_source" "this" {
...
output "id" {
  ...
  value       = sumologic_s3_audit_source.this.id
}

output "url" {
  description = "returns a string"
  value       = sumologic_s3_audit_source.this.url
}

output "this" {
  value = sumologic_s3_audit_source.this
}
```
