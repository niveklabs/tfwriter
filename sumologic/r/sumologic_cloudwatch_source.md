...
```terraform
module "sumologic_cloudwatch_source" {
  source = "./modules/sumologic/r/sumologic_cloudwatch_source"
...
```terraform
resource "sumologic_cloudwatch_source" "this" {
...
output "id" {
  ...
  value       = sumologic_cloudwatch_source.this.id
}

output "url" {
  description = "returns a string"
  value       = sumologic_cloudwatch_source.this.url
}

output "this" {
  value = sumologic_cloudwatch_source.this
}
```
