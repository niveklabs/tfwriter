...
```terraform
module "sumologic_elb_source" {
  source = "./modules/sumologic/r/sumologic_elb_source"
...
output "id" {
  ...
  value       = sumologic_elb_source.this.id
}

output "url" {
  description = "returns a string"
  value       = sumologic_elb_source.this.url
}

output "this" {
  value = sumologic_elb_source.this
}
```
