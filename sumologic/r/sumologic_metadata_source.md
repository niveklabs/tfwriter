...
```terraform
module "sumologic_metadata_source" {
  source = "./modules/sumologic/r/sumologic_metadata_source"
...
resource "sumologic_metadata_source" "this" {
  ...
  dynamic "path" {
    ...
    content {
      ...
      tag_filters         = path.value["tag_filters"]
...
output "id" {
  ...
  value       = sumologic_metadata_source.this.id
}

output "url" {
  description = "returns a string"
  value       = sumologic_metadata_source.this.url
}

output "this" {
  value = sumologic_metadata_source.this
}
```
