...
```terraform
module "sumologic_s3_source" {
  source = "./modules/sumologic/r/sumologic_s3_source"
...
output "id" {
  ...
  value       = sumologic_s3_source.this.id
}

output "url" {
  description = "returns a string"
  value       = sumologic_s3_source.this.url
}

output "this" {
  value = sumologic_s3_source.this
}
```
