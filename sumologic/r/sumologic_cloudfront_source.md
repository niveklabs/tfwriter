...
```terraform
module "sumologic_cloudfront_source" {
  source = "./modules/sumologic/r/sumologic_cloudfront_source"
...
```terraform
resource "sumologic_cloudfront_source" "this" {
  # automatic_date_parsing - (optional) is a type of bool
...
output "id" {
  ...
  value       = sumologic_cloudfront_source.this.id
}

output "url" {
  description = "returns a string"
  value       = sumologic_cloudfront_source.this.url
}

output "this" {
  value = sumologic_cloudfront_source.this
}
```
