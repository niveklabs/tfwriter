...
```terraform
module "sumologic_aws_xray_source" {
  source = "./modules/sumologic/r/sumologic_aws_xray_source"
...
output "id" {
  ...
  value       = sumologic_aws_xray_source.this.id
}

output "url" {
  description = "returns a string"
  value       = sumologic_aws_xray_source.this.url
}

output "this" {
  value = sumologic_aws_xray_source.this
}
```
