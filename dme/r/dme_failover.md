...
```terraform
module "dme_failover" {
  source = "./modules/dme/r/dme_failover"
...
output "auto_failover" {
  ...
  value       = dme_failover.this.auto_failover
}

output "contact_list" {
  description = "returns a string"
  value       = dme_failover.this.contact_list
}

output "dns_fqdn" {
  description = "returns a string"
  value       = dme_failover.this.dns_fqdn
}

output "dns_timeout" {
  description = "returns a string"
  value       = dme_failover.this.dns_timeout
}

output "failover" {
  description = "returns a string"
  value       = dme_failover.this.failover
}

output "http_file" {
  description = "returns a string"
  value       = dme_failover.this.http_file
}

output "http_fqdn" {
  description = "returns a string"
  value       = dme_failover.this.http_fqdn
}

output "http_query_string" {
  description = "returns a string"
  value       = dme_failover.this.http_query_string
}

output "id" {
  description = "returns a string"
  value       = dme_failover.this.id
}

output "ip1" {
  description = "returns a string"
  value       = dme_failover.this.ip1
}

output "ip2" {
  description = "returns a string"
  value       = dme_failover.this.ip2
}

output "ip3" {
  description = "returns a string"
  value       = dme_failover.this.ip3
}

output "ip4" {
  description = "returns a string"
  value       = dme_failover.this.ip4
}

output "ip5" {
  description = "returns a string"
  value       = dme_failover.this.ip5
}

output "max_emails" {
  description = "returns a string"
  value       = dme_failover.this.max_emails
}

output "monitor" {
  description = "returns a string"
  value       = dme_failover.this.monitor
}

output "protocol_id" {
  description = "returns a string"
  value       = dme_failover.this.protocol_id
}

output "send_string" {
  description = "returns a string"
  value       = dme_failover.this.send_string
}

output "system_description" {
  description = "returns a string"
  value       = dme_failover.this.system_description
}

output "timeout" {
  description = "returns a string"
  value       = dme_failover.this.timeout
}
