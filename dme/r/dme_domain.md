...
```terraform
module "dme_domain" {
  source = "./modules/dme/r/dme_domain"
...
output "created" {
  ...
  value       = dme_domain.this.created
}

output "folder_id" {
  description = "returns a string"
  value       = dme_domain.this.folder_id
}

output "gtd_enabled" {
  description = "returns a string"
  value       = dme_domain.this.gtd_enabled
}

output "id" {
  description = "returns a string"
  value       = dme_domain.this.id
}

output "soa_id" {
  description = "returns a string"
  value       = dme_domain.this.soa_id
}

output "template_id" {
  description = "returns a string"
  value       = dme_domain.this.template_id
}

output "transfer_acl_id" {
  description = "returns a string"
  value       = dme_domain.this.transfer_acl_id
}

output "updated" {
  description = "returns a string"
  value       = dme_domain.this.updated
}

output "vanity_id" {
  description = "returns a string"
  value       = dme_domain.this.vanity_id
}
