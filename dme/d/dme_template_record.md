...
module "dme_template_record" {
  source = "./modules/dme/d/dme_template_record"
...
output "caa_type" {
  ...
  value       = data.dme_template_record.this.caa_type
}

output "description" {
  description = "returns a string"
  value       = data.dme_template_record.this.description
}

output "dynamic_dns" {
  description = "returns a string"
  value       = data.dme_template_record.this.dynamic_dns
}

output "gtd_location" {
  description = "returns a string"
  value       = data.dme_template_record.this.gtd_location
}

output "hardlink" {
  description = "returns a string"
  value       = data.dme_template_record.this.hardlink
}

output "id" {
  description = "returns a string"
  value       = data.dme_template_record.this.id
}

output "issuer_critical" {
  description = "returns a string"
  value       = data.dme_template_record.this.issuer_critical
}

output "keywords" {
  description = "returns a string"
  value       = data.dme_template_record.this.keywords
}

output "mx_level" {
  description = "returns a string"
  value       = data.dme_template_record.this.mx_level
}

output "password" {
  description = "returns a string"
  value       = data.dme_template_record.this.password
}

output "port" {
  description = "returns a string"
  value       = data.dme_template_record.this.port
}

output "priority" {
  description = "returns a string"
  value       = data.dme_template_record.this.priority
}

output "redirect_type" {
  description = "returns a string"
  value       = data.dme_template_record.this.redirect_type
}

output "title" {
  description = "returns a string"
  value       = data.dme_template_record.this.title
}

output "ttl" {
  description = "returns a string"
  value       = data.dme_template_record.this.ttl
}

output "value" {
  description = "returns a string"
  value       = data.dme_template_record.this.value
}

output "weight" {
  description = "returns a string"
  value       = data.dme_template_record.this.weight
}
