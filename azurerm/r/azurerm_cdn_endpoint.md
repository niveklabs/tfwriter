...
resource "azurerm_cdn_endpoint" "this" {
  ...
  dynamic "delivery_rule" {
    ...
    content {
      ...
      dynamic "cache_expiration_action" {
        ...
        content {
          # behavior - (required) is a type of string
      ...
      dynamic "cookies_condition" {
        ...
        content {
          # match_values - (optional) is a type of set of string
          match_values = cookies_condition.value["match_values"]
          # negate_condition - (optional) is a type of bool
          ...
          # transforms - (optional) is a type of list of string
      ...
      dynamic "device_condition" {
        ...
        content {
          # match_values - (required) is a type of set of string
      ...
      dynamic "url_rewrite_action" {
        ...
        content {
          ...
          # preserve_unmatched_path - (optional) is a type of bool
          preserve_unmatched_path = url_rewrite_action.value["preserve_unmatched_path"]
          # source_pattern - (required) is a type of string
  ...
  dynamic "geo_filter" {
    ...
    content {
      ...
      # relative_path - (required) is a type of string
