...
```terraform
module "azurerm_sentinel_data_connector_microsoft_defender_advanced_threat_protection" {
  source = "./modules/azurerm/r/azurerm_sentinel_data_connector_microsoft_defender_advanced_threat_protection"
...
output "this" {
  value = azurerm_sentinel_data_connector_microsoft_defender_advanced_threat_protection.this
}
```
