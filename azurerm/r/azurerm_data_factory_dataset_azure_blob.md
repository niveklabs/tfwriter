...
```terraform
module "azurerm_data_factory_dataset_azure_blob" {
  source = "./modules/azurerm/r/azurerm_data_factory_dataset_azure_blob"
...
output "this" {
  value = azurerm_data_factory_dataset_azure_blob.this
}
```
