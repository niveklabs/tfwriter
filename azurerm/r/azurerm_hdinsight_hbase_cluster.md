...
```terraform
module "azurerm_hdinsight_hbase_cluster" {
  source = "./modules/azurerm/r/azurerm_hdinsight_hbase_cluster"
...
```terraform
resource "azurerm_hdinsight_hbase_cluster" "this" {
  # cluster_version - (required) is a type of string
  ...
  dynamic "component_version" {
    ...
    content {
      # hbase - (required) is a type of string
