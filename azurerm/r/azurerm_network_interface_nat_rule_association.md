...
module "azurerm_network_interface_nat_rule_association" {
  source = "./modules/azurerm/r/azurerm_network_interface_nat_rule_association"
...
output "id" {
  ...
  value       = azurerm_network_interface_nat_rule_association.this.id
}

output "this" {
  value = azurerm_network_interface_nat_rule_association.this
}
```
