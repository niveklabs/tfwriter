  ...
  dynamic "policy_option" {
    ...
    content {
      ...
      dynamic "fairplay_configuration" {
        ...
        content {
          # ask - (optional) is a type of string
          ask = fairplay_configuration.value["ask"]
          # pfx - (optional) is a type of string
          ...
          # rental_and_lease_key_type - (optional) is a type of string
          rental_and_lease_key_type = fairplay_configuration.value["rental_and_lease_key_type"]
          # rental_duration_seconds - (optional) is a type of number
          ...
          dynamic "offline_rental_configuration" {
            ...
            content {
              # playback_duration_seconds - (optional) is a type of number
              playback_duration_seconds = offline_rental_configuration.value["playback_duration_seconds"]
              # storage_duration_seconds - (optional) is a type of number
      ...
      dynamic "playready_configuration_license" {
        ...
        content {
          ...
          # relative_begin_date - (optional) is a type of string
          relative_begin_date = playready_configuration_license.value["relative_begin_date"]
          # relative_expiration_date - (optional) is a type of string
          ...
          dynamic "play_right" {
            ...
            content {
              ...
              # image_constraint_for_analog_computer_monitor_restriction - (optional) is a type of bool
              ...
              # scms_restriction - (optional) is a type of number
              scms_restriction = play_right.value["scms_restriction"]
              # uncompressed_digital_audio_opl - (optional) is a type of number
              uncompressed_digital_audio_opl = play_right.value["uncompressed_digital_audio_opl"]
              # uncompressed_digital_video_opl - (optional) is a type of number
