...
```terraform
module "azurerm_data_factory_dataset_delimited_text" {
  source = "./modules/azurerm/r/azurerm_data_factory_dataset_delimited_text"
...
output "id" {
  ...
  value       = azurerm_data_factory_dataset_delimited_text.this.id
}

output "this" {
  value = azurerm_data_factory_dataset_delimited_text.this
}
```
