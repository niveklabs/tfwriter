...
```terraform
module "azurerm_mysql_active_directory_administrator" {
  source = "./modules/azurerm/r/azurerm_mysql_active_directory_administrator"
...
output "this" {
  value = azurerm_mysql_active_directory_administrator.this
}
```
