...
```terraform
module "azurerm_data_factory_linked_service_azure_table_storage" {
  source = "./modules/azurerm/r/azurerm_data_factory_linked_service_azure_table_storage"
...
output "this" {
  value = azurerm_data_factory_linked_service_azure_table_storage.this
}
```
