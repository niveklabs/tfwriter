...
```terraform
module "azurerm_virtual_hub_security_partner_provider" {
  source = "./modules/azurerm/r/azurerm_virtual_hub_security_partner_provider"
  ...
  # security_provider_name - (required) is a type of string
  security_provider_name = null
  # tags - (optional) is a type of map of string
  tags = {}
  # virtual_hub_id - (optional) is a type of string
  virtual_hub_id = null
