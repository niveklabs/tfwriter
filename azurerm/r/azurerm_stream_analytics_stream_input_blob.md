...
```terraform
module "azurerm_stream_analytics_stream_input_blob" {
  source = "./modules/azurerm/r/azurerm_stream_analytics_stream_input_blob"
...
output "this" {
  value = azurerm_stream_analytics_stream_input_blob.this
}
```
