...
module "azurerm_hdinsight_interactive_query_cluster" {
  source = "./modules/azurerm/r/azurerm_hdinsight_interactive_query_cluster"
...
resource "azurerm_hdinsight_interactive_query_cluster" "this" {
  ...
  dynamic "component_version" {
    ...
    content {
      # interactive_hive - (required) is a type of string
  ...
  dynamic "monitor" {
    ...
    content {
      ...
      # primary_key - (required) is a type of string
...
output "https_endpoint" {
  ...
  value       = azurerm_hdinsight_interactive_query_cluster.this.https_endpoint
}

output "id" {
  description = "returns a string"
  value       = azurerm_hdinsight_interactive_query_cluster.this.id
}

output "ssh_endpoint" {
  description = "returns a string"
  value       = azurerm_hdinsight_interactive_query_cluster.this.ssh_endpoint
}

output "this" {
  value = azurerm_hdinsight_interactive_query_cluster.this
}
```
