...
```terraform
module "azurerm_hdinsight_storm_cluster" {
  source = "./modules/azurerm/r/azurerm_hdinsight_storm_cluster"
...
resource "azurerm_hdinsight_storm_cluster" "this" {
  ...
  dynamic "component_version" {
    ...
    content {
      # storm - (required) is a type of string
...
output "https_endpoint" {
  ...
  value       = azurerm_hdinsight_storm_cluster.this.https_endpoint
}

output "id" {
  description = "returns a string"
  value       = azurerm_hdinsight_storm_cluster.this.id
}

output "ssh_endpoint" {
  description = "returns a string"
  value       = azurerm_hdinsight_storm_cluster.this.ssh_endpoint
}

output "this" {
  value = azurerm_hdinsight_storm_cluster.this
}
```
