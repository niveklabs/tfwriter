...
module "azurerm_data_factory_linked_service_cosmosdb" {
  source = "./modules/azurerm/r/azurerm_data_factory_linked_service_cosmosdb"

  # account_endpoint - (optional) is a type of string
...
output "this" {
  value = azurerm_data_factory_linked_service_cosmosdb.this
}
```
