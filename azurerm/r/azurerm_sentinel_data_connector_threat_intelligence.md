...
```terraform
module "azurerm_sentinel_data_connector_threat_intelligence" {
  source = "./modules/azurerm/r/azurerm_sentinel_data_connector_threat_intelligence"
...
output "this" {
  value = azurerm_sentinel_data_connector_threat_intelligence.this
}
```
