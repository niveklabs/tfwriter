...
```terraform
module "azurerm_data_factory_dataset_parquet" {
  source = "./modules/azurerm/r/azurerm_data_factory_dataset_parquet"
...
output "this" {
  value = azurerm_data_factory_dataset_parquet.this
}
```
