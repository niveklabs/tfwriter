...
```terraform
module "azurerm_data_factory_linked_service_synapse" {
  source = "./modules/azurerm/r/azurerm_data_factory_linked_service_synapse"
...
output "this" {
  value = azurerm_data_factory_linked_service_synapse.this
}
```
