...
output "auto_grow_enabled" {
  ...
  value       = azurerm_mysql_server.this.auto_grow_enabled
}

output "backup_retention_days" {
  description = "returns a number"
  value       = azurerm_mysql_server.this.backup_retention_days
}
...
output "geo_redundant_backup_enabled" {
  description = "returns a bool"
  value       = azurerm_mysql_server.this.geo_redundant_backup_enabled
}
...
output "ssl_enforcement" {
  description = "returns a string"
  value       = azurerm_mysql_server.this.ssl_enforcement
}

output "storage_mb" {
  description = "returns a number"
  value       = azurerm_mysql_server.this.storage_mb
}
