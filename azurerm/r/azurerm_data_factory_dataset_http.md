...
```terraform
module "azurerm_data_factory_dataset_http" {
  source = "./modules/azurerm/r/azurerm_data_factory_dataset_http"
...
output "id" {
  ...
  value       = azurerm_data_factory_dataset_http.this.id
}

output "this" {
  value = azurerm_data_factory_dataset_http.this
}
```
