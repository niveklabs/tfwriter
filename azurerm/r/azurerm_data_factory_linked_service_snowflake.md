...
```terraform
module "azurerm_data_factory_linked_service_snowflake" {
  source = "./modules/azurerm/r/azurerm_data_factory_linked_service_snowflake"
...
output "this" {
  value = azurerm_data_factory_linked_service_snowflake.this
}
```
