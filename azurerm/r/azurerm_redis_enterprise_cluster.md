...
```terraform
module "azurerm_redis_enterprise_cluster" {
  source = "./modules/azurerm/r/azurerm_redis_enterprise_cluster"
...
output "version" {
  description = "returns a string"
  value       = azurerm_redis_enterprise_cluster.this.version
}

output "this" {
  value = azurerm_redis_enterprise_cluster.this
}
```
