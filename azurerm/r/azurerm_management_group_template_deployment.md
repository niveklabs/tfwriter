...
```terraform
module "azurerm_management_group_template_deployment" {
  source = "./modules/azurerm/r/azurerm_management_group_template_deployment"
...
output "this" {
  value = azurerm_management_group_template_deployment.this
}
```
