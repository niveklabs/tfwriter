...
module "launchdarkly_feature_flag_environment" {
  source = "./modules/launchdarkly/d/launchdarkly_feature_flag_environment"
...
output "id" {
  ...
  value       = data.launchdarkly_feature_flag_environment.this.id
}

output "off_variation" {
  description = "returns a number"
  value       = data.launchdarkly_feature_flag_environment.this.off_variation
}

output "targeting_enabled" {
  description = "returns a bool"
  value       = data.launchdarkly_feature_flag_environment.this.targeting_enabled
}

output "track_events" {
  description = "returns a bool"
  value       = data.launchdarkly_feature_flag_environment.this.track_events
}
