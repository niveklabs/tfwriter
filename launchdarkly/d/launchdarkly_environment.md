...
module "launchdarkly_environment" {
  source = "./modules/launchdarkly/d/launchdarkly_environment"
...
```terraform
data "launchdarkly_environment" "this" {
  # confirm_changes - (optional) is a type of bool
...
output "api_key" {
  ...
  value       = data.launchdarkly_environment.this.api_key
  sensitive   = true
}

output "client_side_id" {
  description = "returns a string"
  value       = data.launchdarkly_environment.this.client_side_id
  sensitive   = true
}

output "color" {
  description = "returns a string"
  value       = data.launchdarkly_environment.this.color
}

output "confirm_changes" {
  description = "returns a bool"
  value       = data.launchdarkly_environment.this.confirm_changes
}

output "default_track_events" {
  description = "returns a bool"
  value       = data.launchdarkly_environment.this.default_track_events
}

output "default_ttl" {
  description = "returns a number"
  value       = data.launchdarkly_environment.this.default_ttl
}

output "id" {
  description = "returns a string"
  value       = data.launchdarkly_environment.this.id
}

output "mobile_key" {
  description = "returns a string"
  value       = data.launchdarkly_environment.this.mobile_key
  sensitive   = true
}

output "name" {
  description = "returns a string"
  value       = data.launchdarkly_environment.this.name
}

output "require_comments" {
  description = "returns a bool"
  value       = data.launchdarkly_environment.this.require_comments
}

output "secure_mode" {
  description = "returns a bool"
  value       = data.launchdarkly_environment.this.secure_mode
}
