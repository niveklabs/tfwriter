...
```terraform
module "tencentcloud_vod_snapshot_by_time_offset_templates" {
  source = "./modules/tencentcloud/d/tencentcloud_vod_snapshot_by_time_offset_templates"
...
```terraform
data "tencentcloud_vod_snapshot_by_time_offset_templates" "this" {
  # definition - (optional) is a type of string
...
output "id" {
  ...
  value       = data.tencentcloud_vod_snapshot_by_time_offset_templates.this.id
}

output "template_list" {
  description = "returns a list of object"
  value       = data.tencentcloud_vod_snapshot_by_time_offset_templates.this.template_list
}

output "this" {
  value = tencentcloud_vod_snapshot_by_time_offset_templates.this
}
```
