...
```terraform
module "tencentcloud_vod_image_sprite_template" {
  source = "./modules/tencentcloud/r/tencentcloud_vod_image_sprite_template"
...
output "create_time" {
  ...
  value       = tencentcloud_vod_image_sprite_template.this.create_time
}

output "id" {
  description = "returns a string"
  value       = tencentcloud_vod_image_sprite_template.this.id
}

output "update_time" {
  description = "returns a string"
  value       = tencentcloud_vod_image_sprite_template.this.update_time
}

output "this" {
  value = tencentcloud_vod_image_sprite_template.this
}
```
