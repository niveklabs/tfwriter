...
```terraform
module "tencentcloud_mongodb_instance" {
  source = "./modules/tencentcloud/r/tencentcloud_mongodb_instance"
...
output "create_time" {
  ...
  value       = tencentcloud_mongodb_instance.this.create_time
}

output "id" {
  description = "returns a string"
  value       = tencentcloud_mongodb_instance.this.id
}

output "standby_instance_list" {
  description = "returns a list of object"
  value       = tencentcloud_mongodb_instance.this.standby_instance_list
}

output "status" {
  description = "returns a number"
  value       = tencentcloud_mongodb_instance.this.status
}

output "vip" {
  description = "returns a string"
  value       = tencentcloud_mongodb_instance.this.vip
}

output "vport" {
  description = "returns a number"
  value       = tencentcloud_mongodb_instance.this.vport
}

output "this" {
  value = tencentcloud_mongodb_instance.this
}
```
