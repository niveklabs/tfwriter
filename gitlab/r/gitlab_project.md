...
resource "gitlab_project" "this" {
  ...
  dynamic "push_rules" {
    ...
    content {
      ...
      # member_check - (optional) is a type of bool
      member_check = push_rules.value["member_check"]
      # prevent_secrets - (optional) is a type of bool
      prevent_secrets = push_rules.value["prevent_secrets"]
      # reject_unsigned_commits - (optional) is a type of bool
