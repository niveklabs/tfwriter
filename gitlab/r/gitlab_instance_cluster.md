...
```terraform
module "gitlab_instance_cluster" {
  source = "./modules/gitlab/r/gitlab_instance_cluster"
...
output "cluster_type" {
  ...
  value       = gitlab_instance_cluster.this.cluster_type
}

output "created_at" {
  description = "returns a string"
  value       = gitlab_instance_cluster.this.created_at
}

output "id" {
  description = "returns a string"
  value       = gitlab_instance_cluster.this.id
}

output "platform_type" {
  description = "returns a string"
  value       = gitlab_instance_cluster.this.platform_type
}

output "provider_type" {
  description = "returns a string"
  value       = gitlab_instance_cluster.this.provider_type
}

output "this" {
  value = gitlab_instance_cluster.this
}
```
