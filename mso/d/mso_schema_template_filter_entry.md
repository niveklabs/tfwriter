...
module "mso_schema_template_filter_entry" {
  source = "./modules/mso/d/mso_schema_template_filter_entry"
...
output "arp_flag" {
  ...
  value       = data.mso_schema_template_filter_entry.this.arp_flag
}

output "destination_from" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.destination_from
}

output "destination_to" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.destination_to
}

output "display_name" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.display_name
}

output "entry_description" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.entry_description
}

output "entry_display_name" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.entry_display_name
}

output "ether_type" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.ether_type
}

output "id" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.id
}

output "ip_protocol" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.ip_protocol
}

output "match_only_fragments" {
  description = "returns a bool"
  value       = data.mso_schema_template_filter_entry.this.match_only_fragments
}

output "source_from" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.source_from
}

output "source_to" {
  description = "returns a string"
  value       = data.mso_schema_template_filter_entry.this.source_to
}

output "stateful" {
  description = "returns a bool"
  value       = data.mso_schema_template_filter_entry.this.stateful
}

output "tcp_session_rules" {
  description = "returns a list of string"
  value       = data.mso_schema_template_filter_entry.this.tcp_session_rules
}
