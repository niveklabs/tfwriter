...
module "mso_schema_site_anp_epg_subnet" {
  source = "./modules/mso/d/mso_schema_site_anp_epg_subnet"
...
output "description" {
  ...
  value       = data.mso_schema_site_anp_epg_subnet.this.description
}

output "id" {
  description = "returns a string"
  value       = data.mso_schema_site_anp_epg_subnet.this.id
}

output "no_default_gateway" {
  description = "returns a bool"
  value       = data.mso_schema_site_anp_epg_subnet.this.no_default_gateway
}

output "querier" {
  description = "returns a bool"
  value       = data.mso_schema_site_anp_epg_subnet.this.querier
}

output "scope" {
  description = "returns a string"
  value       = data.mso_schema_site_anp_epg_subnet.this.scope
}

output "shared" {
  description = "returns a bool"
  value       = data.mso_schema_site_anp_epg_subnet.this.shared
}
