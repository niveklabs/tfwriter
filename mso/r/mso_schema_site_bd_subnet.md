...
module "mso_schema_site_bd_subnet" {
  source = "./modules/mso/r/mso_schema_site_bd_subnet"
...
output "description" {
  ...
  value       = mso_schema_site_bd_subnet.this.description
}

output "id" {
  description = "returns a string"
  value       = mso_schema_site_bd_subnet.this.id
}

output "no_default_gateway" {
  description = "returns a bool"
  value       = mso_schema_site_bd_subnet.this.no_default_gateway
}

output "querier" {
  description = "returns a bool"
  value       = mso_schema_site_bd_subnet.this.querier
}
