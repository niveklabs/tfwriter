...
module "mso_schema_template_bd" {
  source = "./modules/mso/r/mso_schema_template_bd"
...
output "dhcp_policy" {
  ...
  value       = mso_schema_template_bd.this.dhcp_policy
}

output "id" {
  description = "returns a string"
  value       = mso_schema_template_bd.this.id
}

output "intersite_bum_traffic" {
  description = "returns a bool"
  value       = mso_schema_template_bd.this.intersite_bum_traffic
}

output "layer2_stretch" {
  description = "returns a bool"
  value       = mso_schema_template_bd.this.layer2_stretch
}

output "layer2_unknown_unicast" {
  description = "returns a string"
  value       = mso_schema_template_bd.this.layer2_unknown_unicast
}

output "layer3_multicast" {
  description = "returns a bool"
  value       = mso_schema_template_bd.this.layer3_multicast
}

output "optimize_wan_bandwidth" {
  description = "returns a bool"
  value       = mso_schema_template_bd.this.optimize_wan_bandwidth
}

output "vrf_schema_id" {
  description = "returns a string"
  value       = mso_schema_template_bd.this.vrf_schema_id
}

output "vrf_template_name" {
  description = "returns a string"
  value       = mso_schema_template_bd.this.vrf_template_name
}
