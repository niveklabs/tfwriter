...
module "mso_schema_template_anp_epg" {
  source = "./modules/mso/r/mso_schema_template_anp_epg"
...
output "bd_schema_id" {
  ...
  value       = mso_schema_template_anp_epg.this.bd_schema_id
}

output "bd_template_name" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg.this.bd_template_name
}

output "display_name" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg.this.display_name
}

output "id" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg.this.id
}

output "intra_epg" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg.this.intra_epg
}

output "preferred_group" {
  description = "returns a bool"
  value       = mso_schema_template_anp_epg.this.preferred_group
}

output "useg_epg" {
  description = "returns a bool"
  value       = mso_schema_template_anp_epg.this.useg_epg
}

output "vrf_schema_id" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg.this.vrf_schema_id
}

output "vrf_template_name" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg.this.vrf_template_name
}
