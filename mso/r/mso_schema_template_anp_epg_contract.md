...
module "mso_schema_template_anp_epg_contract" {
  source = "./modules/mso/r/mso_schema_template_anp_epg_contract"
...
output "contract_schema_id" {
  ...
  value       = mso_schema_template_anp_epg_contract.this.contract_schema_id
}

output "contract_template_name" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg_contract.this.contract_template_name
}

output "id" {
  description = "returns a string"
  value       = mso_schema_template_anp_epg_contract.this.id
}
