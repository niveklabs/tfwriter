...
```terraform
module "onelogin_oidc_apps" {
  source = "./modules/onelogin/r/onelogin_oidc_apps"
...
```terraform
resource "onelogin_oidc_apps" "this" {
...
output "auth_method" {
  ...
  value       = onelogin_oidc_apps.this.auth_method
}

output "created_at" {
  description = "returns a string"
  value       = onelogin_oidc_apps.this.created_at
}

output "icon_url" {
  description = "returns a string"
  value       = onelogin_oidc_apps.this.icon_url
}

output "id" {
  description = "returns a string"
  value       = onelogin_oidc_apps.this.id
}

output "policy_id" {
  description = "returns a number"
  value       = onelogin_oidc_apps.this.policy_id
}

output "provisioning" {
  description = "returns a map of bool"
  value       = onelogin_oidc_apps.this.provisioning
}

output "sso" {
  description = "returns a map of string"
  value       = onelogin_oidc_apps.this.sso
  sensitive   = true
}

output "tab_id" {
  description = "returns a number"
  value       = onelogin_oidc_apps.this.tab_id
}

output "updated_at" {
  description = "returns a string"
  value       = onelogin_oidc_apps.this.updated_at
}

output "this" {
  value = onelogin_oidc_apps.this
}
```
