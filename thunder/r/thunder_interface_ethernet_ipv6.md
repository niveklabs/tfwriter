...
```terraform
module "thunder_interface_ethernet_ipv6" {
  source = "./modules/thunder/r/thunder_interface_ethernet_ipv6"
...
```terraform
resource "thunder_interface_ethernet_ipv6" "this" {
  ifnum       = var.ifnum
  inside      = var.inside
...
output "id" {
  ...
  value       = thunder_interface_ethernet_ipv6.this.id
}

output "this" {
  value = thunder_interface_ethernet_ipv6.this
}
```
