...
```terraform
module "thunder_slb_fast_http_proxy" {
  source = "./modules/thunder/r/thunder_slb_fast_http_proxy"
...
```terraform
resource "thunder_slb_fast_http_proxy" "this" {
  # uuid - (optional) is a type of string
  uuid = var.uuid
...
output "id" {
  ...
  value       = thunder_slb_fast_http_proxy.this.id
}

output "this" {
  value = thunder_slb_fast_http_proxy.this
}
```
