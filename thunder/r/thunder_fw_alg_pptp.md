...
```terraform
module "thunder_fw_alg_pptp" {
  source = "./modules/thunder/r/thunder_fw_alg_pptp"
...
```terraform
resource "thunder_fw_alg_pptp" "this" {
  # default_port_disable - (optional) is a type of string
...
output "id" {
  ...
  value       = thunder_fw_alg_pptp.this.id
}

output "this" {
  value = thunder_fw_alg_pptp.this
}
```
