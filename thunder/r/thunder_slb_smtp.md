...
```terraform
module "thunder_slb_smtp" {
  source = "./modules/thunder/r/thunder_slb_smtp"
...
```terraform
resource "thunder_slb_smtp" "this" {
...
output "id" {
  ...
  value       = thunder_slb_smtp.this.id
}

output "this" {
  value = thunder_slb_smtp.this
}
```
