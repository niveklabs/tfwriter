...
```terraform
module "thunder_fw_alg_sip" {
  source = "./modules/thunder/r/thunder_fw_alg_sip"
...
```terraform
resource "thunder_fw_alg_sip" "this" {
...
output "id" {
  ...
  value       = thunder_fw_alg_sip.this.id
}

output "this" {
  value = thunder_fw_alg_sip.this
}
```
