...
```terraform
module "thunder_fw_alg_rtsp" {
  source = "./modules/thunder/r/thunder_fw_alg_rtsp"
...
```terraform
resource "thunder_fw_alg_rtsp" "this" {
  # default_port_disable - (optional) is a type of string
...
output "id" {
  ...
  value       = thunder_fw_alg_rtsp.this.id
}

output "this" {
  value = thunder_fw_alg_rtsp.this
}
```
