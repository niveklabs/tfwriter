...
module "aws_opsworks_nodejs_app_layer" {
  ...
  name = null
  # nodejs_version - (optional) is a type of string
  nodejs_version = null
...
```terraform
resource "aws_opsworks_nodejs_app_layer" "this" {
  # auto_assign_elastic_ips - (optional) is a type of bool
...
output "arn" {
  ...
  value       = aws_opsworks_nodejs_app_layer.this.arn
}

output "id" {
  description = "returns a string"
  value       = aws_opsworks_nodejs_app_layer.this.id
}

output "this" {
  value = aws_opsworks_nodejs_app_layer.this
}
```
