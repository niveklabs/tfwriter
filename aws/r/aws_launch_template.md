...
resource "aws_launch_template" "this" {
  ...
  dynamic "capacity_reservation_specification" {
    ...
    content {
      # capacity_reservation_preference - (optional) is a type of string
  ...
  dynamic "cpu_options" {
    ...
    content {
      ...
      # threads_per_core - (optional) is a type of number
  ...
  dynamic "hibernation_options" {
    ...
    content {
      # configured - (required) is a type of bool
  ...
  dynamic "instance_market_options" {
    ...
    content {
      # market_type - (optional) is a type of string
  ...
  dynamic "network_interfaces" {
    ...
    content {
      # associate_carrier_ip_address - (optional) is a type of string
      associate_carrier_ip_address = network_interfaces.value["associate_carrier_ip_address"]
      # associate_public_ip_address - (optional) is a type of string
      ...
      # ipv4_address_count - (optional) is a type of number
      ipv4_address_count = network_interfaces.value["ipv4_address_count"]
      # ipv4_addresses - (optional) is a type of set of string
  ...
  dynamic "placement" {
    ...
    content {
      ...
      # partition_number - (optional) is a type of number
      partition_number = placement.value["partition_number"]
      # spread_domain - (optional) is a type of string
