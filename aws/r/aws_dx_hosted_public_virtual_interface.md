...
output "amazon_side_asn" {
  description = "returns a string"
  value       = aws_dx_hosted_public_virtual_interface.this.amazon_side_asn
}
...
output "bgp_auth_key" {
  description = "returns a string"
  value       = aws_dx_hosted_public_virtual_interface.this.bgp_auth_key
}

output "customer_address" {
  description = "returns a string"
  value       = aws_dx_hosted_public_virtual_interface.this.customer_address
}
...
output "this" {
  value = aws_dx_hosted_public_virtual_interface.this
}
```
