...
output "id" {
  description = "returns a string"
  value       = aws_db_cluster_snapshot.this.id
}
...
output "snapshot_type" {
  description = "returns a string"
  value       = aws_db_cluster_snapshot.this.snapshot_type
}

output "source_db_cluster_snapshot_arn" {
  description = "returns a string"
  value       = aws_db_cluster_snapshot.this.source_db_cluster_snapshot_arn
}
