...
```terraform
module "panos_panorama_nat_rule" {
  source = "./modules/panos/r/panos_panorama_nat_rule"
...
```terraform
resource "panos_panorama_nat_rule" "this" {
  # dat_address - (optional) is a type of string
...
output "id" {
  ...
  value       = panos_panorama_nat_rule.this.id
}

output "this" {
  value = panos_panorama_nat_rule.this
}
```
