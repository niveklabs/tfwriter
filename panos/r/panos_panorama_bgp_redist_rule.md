...
```terraform
module "panos_panorama_bgp_redist_rule" {
  source = "./modules/panos/r/panos_panorama_bgp_redist_rule"
...
```terraform
resource "panos_panorama_bgp_redist_rule" "this" {
...
output "id" {
  ...
  value       = panos_panorama_bgp_redist_rule.this.id
}

output "this" {
  value = panos_panorama_bgp_redist_rule.this
}
```
