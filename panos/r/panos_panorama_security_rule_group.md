...
```terraform
module "panos_panorama_security_rule_group" {
  source = "./modules/panos/r/panos_panorama_security_rule_group"
...
output "id" {
  ...
  value       = panos_panorama_security_rule_group.this.id
}

output "this" {
  value = panos_panorama_security_rule_group.this
}
```
