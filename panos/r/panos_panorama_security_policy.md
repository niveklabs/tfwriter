...
```terraform
module "panos_panorama_security_policy" {
  source = "./modules/panos/r/panos_panorama_security_policy"
...
output "id" {
  ...
  value       = panos_panorama_security_policy.this.id
}

output "this" {
  value = panos_panorama_security_policy.this
}
```
