...
```terraform
module "panos_panorama_bgp_aggregate_suppress_filter" {
  source = "./modules/panos/r/panos_panorama_bgp_aggregate_suppress_filter"
...
```terraform
resource "panos_panorama_bgp_aggregate_suppress_filter" "this" {
...
output "id" {
  ...
  value       = panos_panorama_bgp_aggregate_suppress_filter.this.id
}

output "this" {
  value = panos_panorama_bgp_aggregate_suppress_filter.this
}
```
