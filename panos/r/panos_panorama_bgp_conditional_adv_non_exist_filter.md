...
```terraform
module "panos_panorama_bgp_conditional_adv_non_exist_filter" {
  source = "./modules/panos/r/panos_panorama_bgp_conditional_adv_non_exist_filter"
...
```terraform
resource "panos_panorama_bgp_conditional_adv_non_exist_filter" "this" {
...
output "id" {
  ...
  value       = panos_panorama_bgp_conditional_adv_non_exist_filter.this.id
}

output "this" {
  value = panos_panorama_bgp_conditional_adv_non_exist_filter.this
}
```
