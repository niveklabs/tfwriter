...
module "panos_application_object" {
  source = "./modules/panos/r/panos_application_object"
...
```terraform
resource "panos_application_object" "this" {
...
output "id" {
  ...
  value       = panos_application_object.this.id
}

output "this" {
  value = panos_application_object.this
}
```
