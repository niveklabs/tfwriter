...
```terraform
module "panos_panorama_ipsec_tunnel" {
  source = "./modules/panos/r/panos_panorama_ipsec_tunnel"
...
output "id" {
  ...
  value       = panos_panorama_ipsec_tunnel.this.id
}

output "mk_auth_key_enc" {
  description = "returns a string"
  value       = panos_panorama_ipsec_tunnel.this.mk_auth_key_enc
  sensitive   = true
}

output "mk_esp_encryption_key_enc" {
  description = "returns a string"
  value       = panos_panorama_ipsec_tunnel.this.mk_esp_encryption_key_enc
  sensitive   = true
}
