...
```terraform
module "panos_bgp_export_rule_group" {
  source = "./modules/panos/r/panos_bgp_export_rule_group"
...
output "id" {
  ...
  value       = panos_bgp_export_rule_group.this.id
}

output "this" {
  value = panos_bgp_export_rule_group.this
}
```
