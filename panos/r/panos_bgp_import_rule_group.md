...
```terraform
module "panos_bgp_import_rule_group" {
  source = "./modules/panos/r/panos_bgp_import_rule_group"
...
```terraform
resource "panos_bgp_import_rule_group" "this" {
...
output "id" {
  ...
  value       = panos_bgp_import_rule_group.this.id
}

output "this" {
  value = panos_bgp_import_rule_group.this
}
```
