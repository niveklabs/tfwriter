...
```terraform
module "panos_layer3_subinterface" {
  source = "./modules/panos/r/panos_layer3_subinterface"
...
```terraform
resource "panos_layer3_subinterface" "this" {
...
output "id" {
  ...
  value       = panos_layer3_subinterface.this.id
}

output "this" {
  value = panos_layer3_subinterface.this
}
```
