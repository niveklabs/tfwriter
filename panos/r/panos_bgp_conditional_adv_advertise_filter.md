...
```terraform
module "panos_bgp_conditional_adv_advertise_filter" {
  source = "./modules/panos/r/panos_bgp_conditional_adv_advertise_filter"
...
output "id" {
  ...
  value       = panos_bgp_conditional_adv_advertise_filter.this.id
}

output "this" {
  value = panos_bgp_conditional_adv_advertise_filter.this
}
```
