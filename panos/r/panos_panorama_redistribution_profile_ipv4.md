...
```terraform
module "panos_panorama_redistribution_profile_ipv4" {
  source = "./modules/panos/r/panos_panorama_redistribution_profile_ipv4"
...
```terraform
resource "panos_panorama_redistribution_profile_ipv4" "this" {
  action                   = var.action
...
output "id" {
  ...
  value       = panos_panorama_redistribution_profile_ipv4.this.id
}

output "this" {
  value = panos_panorama_redistribution_profile_ipv4.this
}
```
