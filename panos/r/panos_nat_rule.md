...
module "panos_nat_rule" {
  source = "./modules/panos/r/panos_nat_rule"
...
output "id" {
  ...
  value       = panos_nat_rule.this.id
}

output "rulebase" {
  description = "returns a string"
  value       = panos_nat_rule.this.rulebase
}

output "this" {
  value = panos_nat_rule.this
}
```
