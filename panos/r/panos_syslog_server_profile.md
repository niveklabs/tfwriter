...
```terraform
module "panos_syslog_server_profile" {
  source = "./modules/panos/r/panos_syslog_server_profile"
...
```terraform
resource "panos_syslog_server_profile" "this" {
...
output "id" {
  ...
  value       = panos_syslog_server_profile.this.id
}

output "this" {
  value = panos_syslog_server_profile.this
}
```
