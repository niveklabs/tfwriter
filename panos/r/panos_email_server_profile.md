...
```terraform
module "panos_email_server_profile" {
  source = "./modules/panos/r/panos_email_server_profile"
...
output "id" {
  ...
  value       = panos_email_server_profile.this.id
}

output "this" {
  value = panos_email_server_profile.this
}
```
