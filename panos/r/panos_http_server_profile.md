...
```terraform
module "panos_http_server_profile" {
  source = "./modules/panos/r/panos_http_server_profile"
...
output "id" {
  ...
  value       = panos_http_server_profile.this.id
}

output "password_enc" {
  description = "returns a map of string"
  value       = panos_http_server_profile.this.password_enc
  sensitive   = true
}

output "password_raw" {
  description = "returns a map of string"
  value       = panos_http_server_profile.this.password_raw
  sensitive   = true
}

output "this" {
  value = panos_http_server_profile.this
}
```
