...
```terraform
module "panos_panorama_security_policies" {
  source = "./modules/panos/r/panos_panorama_security_policies"
...
```terraform
resource "panos_panorama_security_policies" "this" {
...
output "id" {
  ...
  value       = panos_panorama_security_policies.this.id
}

output "this" {
  value = panos_panorama_security_policies.this
}
```
