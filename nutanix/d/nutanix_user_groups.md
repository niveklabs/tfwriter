...
```terraform
module "nutanix_user_groups" {
  source = "./modules/nutanix/d/nutanix_user_groups"
...
output "api_version" {
  ...
  value       = data.nutanix_user_groups.this.api_version
}

output "entities" {
  description = "returns a list of object"
  value       = data.nutanix_user_groups.this.entities
}

output "id" {
  description = "returns a string"
  value       = data.nutanix_user_groups.this.id
}

output "this" {
  value = nutanix_user_groups.this
}
```
