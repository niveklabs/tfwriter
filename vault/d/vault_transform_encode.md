...
```terraform
module "vault_transform_encode" {
  source = "./modules/vault/d/vault_transform_encode"

  # batch_input - (optional) is a type of list of map of string
  batch_input = [{}]
  # batch_results - (optional) is a type of list of map of string
  batch_results = [{}]
  # encoded_value - (optional) is a type of string
  encoded_value = null
...
variable "batch_results" {
  description = "(optional) - The result of encoding batch_input."
  type        = list(map(string))
  default     = null
}
...
```terraform
data "vault_transform_encode" "this" {
  batch_input    = var.batch_input
  batch_results  = var.batch_results
  encoded_value  = var.encoded_value
  path           = var.path
...
output "batch_results" {
  ...
  value       = data.vault_transform_encode.this.batch_results
}

output "encoded_value" {
  description = "returns a string"
  value       = data.vault_transform_encode.this.encoded_value
}

output "id" {
  description = "returns a string"
  value       = data.vault_transform_encode.this.id
}

output "this" {
  value = vault_transform_encode.this
}
```
