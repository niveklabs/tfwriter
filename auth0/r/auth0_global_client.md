...
```terraform
module "auth0_global_client" {
  source = "./modules/auth0/r/auth0_global_client"
...
```terraform
resource "auth0_global_client" "this" {
  # allowed_logout_urls - (optional) is a type of list of string
...
output "allowed_logout_urls" {
  ...
  value       = auth0_global_client.this.allowed_logout_urls
}

output "allowed_origins" {
  description = "returns a list of string"
  value       = auth0_global_client.this.allowed_origins
}

output "app_type" {
  description = "returns a string"
  value       = auth0_global_client.this.app_type
}

output "callbacks" {
  description = "returns a list of string"
  value       = auth0_global_client.this.callbacks
}

output "client_id" {
  description = "returns a string"
  value       = auth0_global_client.this.client_id
}

output "client_metadata" {
  description = "returns a map of string"
  value       = auth0_global_client.this.client_metadata
}

output "client_secret" {
  description = "returns a string"
  value       = auth0_global_client.this.client_secret
  sensitive   = true
}

output "cross_origin_auth" {
  description = "returns a bool"
  value       = auth0_global_client.this.cross_origin_auth
}

output "cross_origin_loc" {
  description = "returns a string"
  value       = auth0_global_client.this.cross_origin_loc
}

output "custom_login_page" {
  description = "returns a string"
  value       = auth0_global_client.this.custom_login_page
}

output "custom_login_page_on" {
  description = "returns a bool"
  value       = auth0_global_client.this.custom_login_page_on
}

output "custom_login_page_preview" {
  description = "returns a string"
  value       = auth0_global_client.this.custom_login_page_preview
}

output "description" {
  description = "returns a string"
  value       = auth0_global_client.this.description
}

output "encryption_key" {
  description = "returns a map of string"
  value       = auth0_global_client.this.encryption_key
}

output "form_template" {
  description = "returns a string"
  value       = auth0_global_client.this.form_template
}

output "grant_types" {
  description = "returns a list of string"
  value       = auth0_global_client.this.grant_types
}

output "id" {
  description = "returns a string"
  value       = auth0_global_client.this.id
}

output "initiate_login_uri" {
  description = "returns a string"
  value       = auth0_global_client.this.initiate_login_uri
}

output "is_first_party" {
  description = "returns a bool"
  value       = auth0_global_client.this.is_first_party
}

output "is_token_endpoint_ip_header_trusted" {
  description = "returns a bool"
  value       = auth0_global_client.this.is_token_endpoint_ip_header_trusted
}

output "logo_uri" {
  description = "returns a string"
  value       = auth0_global_client.this.logo_uri
}

output "name" {
  description = "returns a string"
  value       = auth0_global_client.this.name
}

output "oidc_conformant" {
  description = "returns a bool"
  value       = auth0_global_client.this.oidc_conformant
}

output "sso" {
  description = "returns a bool"
  value       = auth0_global_client.this.sso
}

output "sso_disabled" {
  description = "returns a bool"
  value       = auth0_global_client.this.sso_disabled
}

output "token_endpoint_auth_method" {
  description = "returns a string"
  value       = auth0_global_client.this.token_endpoint_auth_method
}

output "web_origins" {
  description = "returns a list of string"
  value       = auth0_global_client.this.web_origins
}

output "this" {
  value = auth0_global_client.this
}
```
