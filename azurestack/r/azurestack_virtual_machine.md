...
```terraform
module "azurestack_virtual_machine" {
  source = "./modules/azurestack/r/azurestack_virtual_machine"
...
```terraform
resource "azurestack_virtual_machine" "this" {
  # availability_set_id - (optional) is a type of string
...
output "availability_set_id" {
  ...
  value       = azurestack_virtual_machine.this.availability_set_id
}

output "id" {
  description = "returns a string"
  value       = azurestack_virtual_machine.this.id
}

output "license_type" {
  description = "returns a string"
  value       = azurestack_virtual_machine.this.license_type
}

output "tags" {
  description = "returns a map of string"
  value       = azurestack_virtual_machine.this.tags
}

output "this" {
  value = azurestack_virtual_machine.this
}
```
