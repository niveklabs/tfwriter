...
module "google_compute_forwarding_rule" {
  source = "./modules/google-beta/d/google_compute_forwarding_rule"
...
output "label_fingerprint" {
  description = "returns a string"
  value       = data.google_compute_forwarding_rule.this.label_fingerprint
}

output "labels" {
  description = "returns a map of string"
  value       = data.google_compute_forwarding_rule.this.labels
}
