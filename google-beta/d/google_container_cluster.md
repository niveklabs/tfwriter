...
module "google_container_cluster" {
  source = "./modules/google-beta/d/google_container_cluster"
...
output "cluster_telemetry" {
  description = "returns a list of object"
  value       = data.google_container_cluster.this.cluster_telemetry
}

output "confidential_nodes" {
  description = "returns a list of object"
  value       = data.google_container_cluster.this.confidential_nodes
}
...
output "notification_config" {
  description = "returns a list of object"
  value       = data.google_container_cluster.this.notification_config
}
