...
module "google_identity_platform_default_supported_idp_config" {
  source = "./modules/google-beta/r/google_identity_platform_default_supported_idp_config"
...
output "id" {
  ...
  value       = google_identity_platform_default_supported_idp_config.this.id
}

output "name" {
  description = "returns a string"
  value       = google_identity_platform_default_supported_idp_config.this.name
}

output "project" {
  description = "returns a string"
  value       = google_identity_platform_default_supported_idp_config.this.project
}

output "this" {
  value = google_identity_platform_default_supported_idp_config.this
}
```
