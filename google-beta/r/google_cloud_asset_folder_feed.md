...
module "google_cloud_asset_folder_feed" {
  source = "./modules/google-beta/r/google_cloud_asset_folder_feed"
...
variable "folder" {
  description = "(required) - The folder this feed should be created in."
  type        = string
}
...
output "folder_id" {
  ...
  value       = google_cloud_asset_folder_feed.this.folder_id
}

output "id" {
  description = "returns a string"
  value       = google_cloud_asset_folder_feed.this.id
}

output "name" {
  description = "returns a string"
  value       = google_cloud_asset_folder_feed.this.name
}

output "this" {
  value = google_cloud_asset_folder_feed.this
}
```
