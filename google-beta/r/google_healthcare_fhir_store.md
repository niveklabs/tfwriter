...
module "google_healthcare_fhir_store" {
  source = "./modules/google-beta/r/google_healthcare_fhir_store"
...
variable "version" {
  description = "(optional) - The FHIR specification version. Default value: \"STU3\" Possible values: [\"DSTU2\", \"STU3\", \"R4\"]"
  type        = string
  default     = null
}
