...
module "google_compute_instance_from_template" {
  source = "./modules/google-beta/r/google_compute_instance_from_template"
...
resource "google_compute_instance_from_template" "this" {
  ...
  dynamic "network_interface" {
    ...
    content {
      # access_config - (optional) is a type of list of object
      access_config = network_interface.value["access_config"]
      # alias_ip_range - (optional) is a type of list of object
