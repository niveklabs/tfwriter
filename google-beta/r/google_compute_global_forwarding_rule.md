...
module "google_compute_global_forwarding_rule" {
  source = "./modules/google-beta/r/google_compute_global_forwarding_rule"
...
output "label_fingerprint" {
  description = "returns a string"
  value       = google_compute_global_forwarding_rule.this.label_fingerprint
}

output "network" {
  description = "returns a string"
  value       = google_compute_global_forwarding_rule.this.network
}
