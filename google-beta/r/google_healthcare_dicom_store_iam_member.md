...
module "google_healthcare_dicom_store_iam_member" {
  source = "./modules/google-beta/r/google_healthcare_dicom_store_iam_member"
...
output "etag" {
  ...
  value       = google_healthcare_dicom_store_iam_member.this.etag
}

output "id" {
  description = "returns a string"
  value       = google_healthcare_dicom_store_iam_member.this.id
}

output "this" {
  value = google_healthcare_dicom_store_iam_member.this
}
```
