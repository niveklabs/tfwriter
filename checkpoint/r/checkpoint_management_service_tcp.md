...
```terraform
module "checkpoint_management_service_tcp" {
  source = "./modules/checkpoint/r/checkpoint_management_service_tcp"
...
output "id" {
  ...
  value       = checkpoint_management_service_tcp.this.id
}

output "this" {
  value = checkpoint_management_service_tcp.this
}
```
