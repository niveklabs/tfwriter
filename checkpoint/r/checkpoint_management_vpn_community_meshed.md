...
```terraform
module "checkpoint_management_vpn_community_meshed" {
  source = "./modules/checkpoint/r/checkpoint_management_vpn_community_meshed"
...
output "id" {
  ...
  value       = checkpoint_management_vpn_community_meshed.this.id
}

output "this" {
  value = checkpoint_management_vpn_community_meshed.this
}
```
