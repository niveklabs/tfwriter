...
```terraform
module "checkpoint_management_address_range" {
  source = "./modules/checkpoint/r/checkpoint_management_address_range"
...
```terraform
resource "checkpoint_management_address_range" "this" {
  color              = var.color
...
output "id" {
  ...
  value       = checkpoint_management_address_range.this.id
}

output "this" {
  value = checkpoint_management_address_range.this
}
```
