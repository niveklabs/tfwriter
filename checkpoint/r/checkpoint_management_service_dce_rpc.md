...
```terraform
module "checkpoint_management_service_dce_rpc" {
  source = "./modules/checkpoint/r/checkpoint_management_service_dce_rpc"
...
output "id" {
  ...
  value       = checkpoint_management_service_dce_rpc.this.id
}

output "this" {
  value = checkpoint_management_service_dce_rpc.this
}
```
