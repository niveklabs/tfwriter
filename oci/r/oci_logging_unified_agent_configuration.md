...
resource "oci_logging_unified_agent_configuration" "this" {
  ...
  dynamic "group_association" {
    ...
    content {
      # group_list - (optional) is a type of list of string
  ...
  dynamic "service_configuration" {
    ...
    content {
      ...
      dynamic "destination" {
        ...
        content {
          # log_object_id - (required) is a type of string
      ...
      dynamic "sources" {
        ...
        content {
          # channels - (optional) is a type of list of string
