...
module "oci_load_balancer" {
  source = "./modules/oci/r/oci_load_balancer"
...
output "defined_tags" {
  ...
  value       = oci_load_balancer.this.defined_tags
}

output "freeform_tags" {
  description = "returns a map of string"
  value       = oci_load_balancer.this.freeform_tags
}
...
output "ip_address_details" {
  ...
  value       = oci_load_balancer.this.ip_address_details
}
...
output "ip_mode" {
  description = "returns a string"
  value       = oci_load_balancer.this.ip_mode
}

output "is_private" {
  description = "returns a bool"
  value       = oci_load_balancer.this.is_private
}

output "state" {
  description = "returns a string"
  value       = oci_load_balancer.this.state
}

output "system_tags" {
  description = "returns a map of string"
  value       = oci_load_balancer.this.system_tags
}

output "time_created" {
  description = "returns a string"
  value       = oci_load_balancer.this.time_created
}

output "this" {
  value = oci_load_balancer.this
}
```
