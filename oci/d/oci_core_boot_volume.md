...
output "boot_volume_replicas" {
  ...
  value       = data.oci_core_boot_volume.this.boot_volume_replicas
}

output "boot_volume_replicas_deletion" {
  description = "returns a bool"
  value       = data.oci_core_boot_volume.this.boot_volume_replicas_deletion
}
