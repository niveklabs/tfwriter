...
resource "vsphere_distributed_virtual_switch" "this" {
  ...
  dynamic "host" {
    for_each = var.host
    content {
      # devices - (required) is a type of list of string
  ...
  dynamic "pvlan_mapping" {
    ...
    content {
      # primary_vlan_id - (required) is a type of number
      primary_vlan_id = pvlan_mapping.value["primary_vlan_id"]
      # pvlan_type - (required) is a type of string
      pvlan_type = pvlan_mapping.value["pvlan_type"]
      # secondary_vlan_id - (required) is a type of number
