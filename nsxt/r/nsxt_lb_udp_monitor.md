...
```terraform
module "nsxt_lb_udp_monitor" {
  source = "./modules/nsxt/r/nsxt_lb_udp_monitor"
  ...
  monitor_port = null
  # receive - (required) is a type of string
  receive = null
  # rise_count - (optional) is a type of number
  rise_count = null
  # send - (required) is a type of string
  send = null
...
variable "send" {
  description = "(required) - The data to be sent to the monitored server."
  type        = string
}
...
```terraform
resource "nsxt_lb_udp_monitor" "this" {
...
output "display_name" {
  ...
  value       = nsxt_lb_udp_monitor.this.display_name
}

output "id" {
  description = "returns a string"
  value       = nsxt_lb_udp_monitor.this.id
}

output "revision" {
  description = "returns a number"
  value       = nsxt_lb_udp_monitor.this.revision
}

output "this" {
  value = nsxt_lb_udp_monitor.this
}
```
