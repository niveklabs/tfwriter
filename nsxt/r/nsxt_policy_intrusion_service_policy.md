...
```terraform
module "nsxt_policy_intrusion_service_policy" {
  source = "./modules/nsxt/r/nsxt_policy_intrusion_service_policy"
...
output "id" {
  ...
  value       = nsxt_policy_intrusion_service_policy.this.id
}

output "nsx_id" {
  description = "returns a string"
  value       = nsxt_policy_intrusion_service_policy.this.nsx_id
}

output "path" {
  description = "returns a string"
  value       = nsxt_policy_intrusion_service_policy.this.path
}

output "revision" {
  description = "returns a number"
  value       = nsxt_policy_intrusion_service_policy.this.revision
}

output "this" {
  value = nsxt_policy_intrusion_service_policy.this
}
```
