...
```terraform
module "nsxt_lb_tcp_virtual_server" {
  source = "./modules/nsxt/r/nsxt_lb_tcp_virtual_server"
...
output "display_name" {
  ...
  value       = nsxt_lb_tcp_virtual_server.this.display_name
}

output "id" {
  description = "returns a string"
  value       = nsxt_lb_tcp_virtual_server.this.id
}

output "revision" {
  description = "returns a number"
  value       = nsxt_lb_tcp_virtual_server.this.revision
}

output "this" {
  value = nsxt_lb_tcp_virtual_server.this
}
```
