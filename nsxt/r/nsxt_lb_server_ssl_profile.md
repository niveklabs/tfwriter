...
```terraform
module "nsxt_lb_server_ssl_profile" {
  source = "./modules/nsxt/r/nsxt_lb_server_ssl_profile"
...
output "ciphers" {
  ...
  value       = nsxt_lb_server_ssl_profile.this.ciphers
}

output "display_name" {
  description = "returns a string"
  value       = nsxt_lb_server_ssl_profile.this.display_name
}

output "id" {
  description = "returns a string"
  value       = nsxt_lb_server_ssl_profile.this.id
}

output "is_secure" {
  description = "returns a bool"
  value       = nsxt_lb_server_ssl_profile.this.is_secure
}

output "protocols" {
  description = "returns a set of string"
  value       = nsxt_lb_server_ssl_profile.this.protocols
}

output "revision" {
  description = "returns a number"
  value       = nsxt_lb_server_ssl_profile.this.revision
}

output "this" {
  value = nsxt_lb_server_ssl_profile.this
}
```
