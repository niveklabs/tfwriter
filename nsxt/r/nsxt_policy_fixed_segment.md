...
```terraform
module "nsxt_policy_fixed_segment" {
  source = "./modules/nsxt/r/nsxt_policy_fixed_segment"

  # connectivity_path - (required) is a type of string
...
output "id" {
  ...
  value       = nsxt_policy_fixed_segment.this.id
}

output "nsx_id" {
  description = "returns a string"
  value       = nsxt_policy_fixed_segment.this.nsx_id
}

output "overlay_id" {
  description = "returns a number"
  value       = nsxt_policy_fixed_segment.this.overlay_id
}

output "path" {
  description = "returns a string"
  value       = nsxt_policy_fixed_segment.this.path
}

output "revision" {
  description = "returns a number"
  value       = nsxt_policy_fixed_segment.this.revision
}

output "this" {
  value = nsxt_policy_fixed_segment.this
}
```
