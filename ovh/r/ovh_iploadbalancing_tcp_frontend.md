...
```terraform
module "ovh_iploadbalancing_tcp_frontend" {
  source = "./modules/ovh/r/ovh_iploadbalancing_tcp_frontend"
...
```terraform
resource "ovh_iploadbalancing_tcp_frontend" "this" {
...
output "default_farm_id" {
  ...
  value       = ovh_iploadbalancing_tcp_frontend.this.default_farm_id
}

output "default_ssl_id" {
  description = "returns a number"
  value       = ovh_iploadbalancing_tcp_frontend.this.default_ssl_id
}

output "id" {
  description = "returns a string"
  value       = ovh_iploadbalancing_tcp_frontend.this.id
}

output "this" {
  value = ovh_iploadbalancing_tcp_frontend.this
}
```
