...
```terraform
module "ovh_cloud_project_user" {
  source = "./modules/ovh/r/ovh_cloud_project_user"
...
output "creation_date" {
  ...
  value       = ovh_cloud_project_user.this.creation_date
}
...
output "openstack_rc" {
  ...
  value       = ovh_cloud_project_user.this.openstack_rc
}

output "password" {
  description = "returns a string"
  value       = ovh_cloud_project_user.this.password
  sensitive   = true
}

output "project_id" {
  description = "returns a string"
  value       = ovh_cloud_project_user.this.project_id
}

output "roles" {
  description = "returns a list of object"
  value       = ovh_cloud_project_user.this.roles
}

output "service_name" {
  description = "returns a string"
  value       = ovh_cloud_project_user.this.service_name
}

output "status" {
  description = "returns a string"
  value       = ovh_cloud_project_user.this.status
}

output "username" {
  description = "returns a string"
  value       = ovh_cloud_project_user.this.username
}

output "this" {
  value = ovh_cloud_project_user.this
}
```
