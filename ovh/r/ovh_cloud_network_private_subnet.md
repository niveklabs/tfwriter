...
```terraform
module "ovh_cloud_network_private_subnet" {
  source = "./modules/ovh/r/ovh_cloud_network_private_subnet"
...
output "cidr" {
  ...
  value       = ovh_cloud_network_private_subnet.this.cidr
}

output "gateway_ip" {
  description = "returns a string"
  value       = ovh_cloud_network_private_subnet.this.gateway_ip
}

output "id" {
  description = "returns a string"
  value       = ovh_cloud_network_private_subnet.this.id
}

output "ip_pools" {
  description = "returns a set of object"
  value       = ovh_cloud_network_private_subnet.this.ip_pools
}

output "project_id" {
  description = "returns a string"
  value       = ovh_cloud_network_private_subnet.this.project_id
}

output "service_name" {
  description = "returns a string"
  value       = ovh_cloud_network_private_subnet.this.service_name
}

output "this" {
  value = ovh_cloud_network_private_subnet.this
}
```
