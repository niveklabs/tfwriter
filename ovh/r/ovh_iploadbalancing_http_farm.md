...
```terraform
module "ovh_iploadbalancing_http_farm" {
  source = "./modules/ovh/r/ovh_iploadbalancing_http_farm"
...
output "id" {
  ...
  value       = ovh_iploadbalancing_http_farm.this.id
}

output "this" {
  value = ovh_iploadbalancing_http_farm.this
}
```
