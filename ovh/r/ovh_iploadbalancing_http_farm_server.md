...
```terraform
module "ovh_iploadbalancing_http_farm_server" {
  source = "./modules/ovh/r/ovh_iploadbalancing_http_farm_server"
...
output "cookie" {
  ...
  value       = ovh_iploadbalancing_http_farm_server.this.cookie
}

output "id" {
  description = "returns a string"
  value       = ovh_iploadbalancing_http_farm_server.this.id
}

output "this" {
  value = ovh_iploadbalancing_http_farm_server.this
}
```
