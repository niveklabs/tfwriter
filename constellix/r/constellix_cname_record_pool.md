...
module "constellix_cname_record_pool" {
  source = "./modules/constellix/r/constellix_cname_record_pool"
...
output "disable_flag" {
  ...
  value       = constellix_cname_record_pool.this.disable_flag
}

output "failed_flag" {
  description = "returns a string"
  value       = constellix_cname_record_pool.this.failed_flag
}

output "id" {
  description = "returns a string"
  value       = constellix_cname_record_pool.this.id
}

output "note" {
  description = "returns a string"
  value       = constellix_cname_record_pool.this.note
}

output "version" {
  description = "returns a number"
  value       = constellix_cname_record_pool.this.version
}
