...
module "constellix_spf_record" {
  source = "./modules/constellix/r/constellix_spf_record"
...
output "gtd_region" {
  ...
  value       = constellix_spf_record.this.gtd_region
}

output "id" {
  description = "returns a string"
  value       = constellix_spf_record.this.id
}

output "noanswer" {
  description = "returns a bool"
  value       = constellix_spf_record.this.noanswer
}

output "note" {
  description = "returns a string"
  value       = constellix_spf_record.this.note
}

output "type" {
  description = "returns a string"
  value       = constellix_spf_record.this.type
}
