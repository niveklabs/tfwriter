...
output "created_or_updated_by" {
  ...
  value       = lacework_integration_gcp_at.this.created_or_updated_by
}

output "created_or_updated_time" {
  description = "returns a string"
  value       = lacework_integration_gcp_at.this.created_or_updated_time
}

output "id" {
  description = "returns a string"
  value       = lacework_integration_gcp_at.this.id
}

output "intg_guid" {
  description = "returns a string"
  value       = lacework_integration_gcp_at.this.intg_guid
}

output "org_level" {
  description = "returns a bool"
  value       = lacework_integration_gcp_at.this.org_level
}

output "type_name" {
  description = "returns a string"
  value       = lacework_integration_gcp_at.this.type_name
}

output "this" {
  value = lacework_integration_gcp_at.this
}
```
