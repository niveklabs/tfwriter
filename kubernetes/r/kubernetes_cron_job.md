...
resource "kubernetes_cron_job" "this" {
  ...
  dynamic "spec" {
    for_each = var.spec
    content {
      # concurrency_policy - (optional) is a type of string
      concurrency_policy = spec.value["concurrency_policy"]
      # failed_jobs_history_limit - (optional) is a type of number
      ...
      # starting_deadline_seconds - (optional) is a type of number
      starting_deadline_seconds = spec.value["starting_deadline_seconds"]
      # successful_jobs_history_limit - (optional) is a type of number
