  ...
  dynamic "spec" {
    ...
    content {
      ...
      dynamic "template" {
        ...
        content {
          active_deadline_seconds          = template.value["active_deadline_seconds"]
          automount_service_account_token  = template.value["automount_service_account_token"]
          dns_policy                       = template.value["dns_policy"]
          enable_service_links             = template.value["enable_service_links"]
          host_ipc                         = template.value["host_ipc"]
          host_network                     = template.value["host_network"]
          host_pid                         = template.value["host_pid"]
          hostname                         = template.value["hostname"]
          node_name                        = template.value["node_name"]
          node_selector                    = template.value["node_selector"]
          priority_class_name              = template.value["priority_class_name"]
          restart_policy                   = template.value["restart_policy"]
          service_account_name             = template.value["service_account_name"]
          share_process_namespace          = template.value["share_process_namespace"]
          subdomain                        = template.value["subdomain"]
          termination_grace_period_seconds = template.value["termination_grace_period_seconds"]

          dynamic "affinity" {
            for_each = template.value.affinity
            content {
          ...
          dynamic "dns_config" {
            for_each = template.value.dns_config
            content {
          ...
          dynamic "host_aliases" {
            for_each = template.value.host_aliases
            content {
          ...
          dynamic "image_pull_secrets" {
            for_each = template.value.image_pull_secrets
            content {
          ...
          dynamic "readiness_gate" {
            for_each = template.value.readiness_gate
            content {
          ...
          dynamic "security_context" {
            for_each = template.value.security_context
            content {
          ...
          dynamic "toleration" {
            for_each = template.value.toleration
            content {
              effect             = toleration.value["effect"]
              key                = toleration.value["key"]
              operator           = toleration.value["operator"]
