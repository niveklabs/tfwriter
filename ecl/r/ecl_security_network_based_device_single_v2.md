...
module "ecl_security_network_based_device_single_v2" {
  source = "./modules/ecl/r/ecl_security_network_based_device_single_v2"
...
output "id" {
  ...
  value       = ecl_security_network_based_device_single_v2.this.id
}

output "this" {
  value = ecl_security_network_based_device_single_v2.this
}
```
