...
```terraform
module "ecl_security_network_based_waf_single_v1" {
  source = "./modules/ecl/r/ecl_security_network_based_waf_single_v1"
...
```terraform
resource "ecl_security_network_based_waf_single_v1" "this" {
...
output "id" {
  ...
  value       = ecl_security_network_based_waf_single_v1.this.id
}

output "this" {
  value = ecl_security_network_based_waf_single_v1.this
}
```
