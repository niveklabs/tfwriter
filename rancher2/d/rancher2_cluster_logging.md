...
module "rancher2_cluster_logging" {
  source = "./modules/rancher2/d/rancher2_cluster_logging"
...
output "custom_target_config" {
  ...
  value       = data.rancher2_cluster_logging.this.custom_target_config
}
...
output "enable_json_parsing" {
  ...
  value       = data.rancher2_cluster_logging.this.enable_json_parsing
}
