...
output "annotations" {
  ...
  value       = rancher2_auth_config_adfs.this.annotations
}

output "id" {
  description = "returns a string"
  value       = rancher2_auth_config_adfs.this.id
}

output "labels" {
  description = "returns a map of string"
  value       = rancher2_auth_config_adfs.this.labels
}

output "name" {
  description = "returns a string"
  value       = rancher2_auth_config_adfs.this.name
}

output "type" {
  description = "returns a string"
  value       = rancher2_auth_config_adfs.this.type
}

output "this" {
  value = rancher2_auth_config_adfs.this
}
```
