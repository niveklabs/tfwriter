...
output "approve_value" {
  ...
  value       = alicloud_quotas_quota_application.this.approve_value
}

output "audit_reason" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.audit_reason
}

output "effective_time" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.effective_time
}

output "expire_time" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.expire_time
}

output "id" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.id
}

output "quota_description" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.quota_description
}

output "quota_name" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.quota_name
}

output "quota_unit" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.quota_unit
}

output "status" {
  description = "returns a string"
  value       = alicloud_quotas_quota_application.this.status
}

output "this" {
  value = alicloud_quotas_quota_application.this
}
```
