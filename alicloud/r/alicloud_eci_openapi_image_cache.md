...
module "alicloud_eci_openapi_image_cache" {
  source = "./modules/alicloud/r/alicloud_eci_openapi_image_cache"
...
output "container_group_id" {
  ...
  value       = alicloud_eci_openapi_image_cache.this.container_group_id
}

output "id" {
  description = "returns a string"
  value       = alicloud_eci_openapi_image_cache.this.id
}

output "status" {
  description = "returns a string"
  value       = alicloud_eci_openapi_image_cache.this.status
}

output "this" {
  value = alicloud_eci_openapi_image_cache.this
}
```
