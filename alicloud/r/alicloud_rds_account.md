...
module "alicloud_rds_account" {
  source = "./modules/alicloud/r/alicloud_rds_account"
...
output "account_description" {
  ...
  value       = alicloud_rds_account.this.account_description
}
...
output "account_password" {
  description = "returns a string"
  value       = alicloud_rds_account.this.account_password
  sensitive   = true
}

output "account_type" {
  description = "returns a string"
  value       = alicloud_rds_account.this.account_type
}

output "db_instance_id" {
  description = "returns a string"
  value       = alicloud_rds_account.this.db_instance_id
}

output "description" {
  description = "returns a string"
  value       = alicloud_rds_account.this.description
}

output "id" {
  description = "returns a string"
  value       = alicloud_rds_account.this.id
}

output "instance_id" {
  description = "returns a string"
  value       = alicloud_rds_account.this.instance_id
}

output "name" {
  description = "returns a string"
  value       = alicloud_rds_account.this.name
}

output "password" {
  description = "returns a string"
  value       = alicloud_rds_account.this.password
  sensitive   = true
}

output "status" {
  description = "returns a string"
  value       = alicloud_rds_account.this.status
}

output "type" {
  description = "returns a string"
  value       = alicloud_rds_account.this.type
}

output "this" {
  value = alicloud_rds_account.this
}
```
