...
```terraform
module "alicloud_quotas_quota_applications" {
  source = "./modules/alicloud/d/alicloud_quotas_quota_applications"
...
```terraform
data "alicloud_quotas_quota_applications" "this" {
...
output "applications" {
  ...
  value       = data.alicloud_quotas_quota_applications.this.applications
}

output "id" {
  description = "returns a string"
  value       = data.alicloud_quotas_quota_applications.this.id
}

output "ids" {
  description = "returns a list of string"
  value       = data.alicloud_quotas_quota_applications.this.ids
}

output "this" {
  value = alicloud_quotas_quota_applications.this
}
```
