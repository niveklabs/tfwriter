...
output "admin_st" {
  ...
  value       = aci_cdp_interface_policy.this.admin_st
}

output "description" {
  description = "returns a string"
  value       = aci_cdp_interface_policy.this.description
}

output "id" {
  description = "returns a string"
  value       = aci_cdp_interface_policy.this.id
}

output "name_alias" {
  description = "returns a string"
  value       = aci_cdp_interface_policy.this.name_alias
}
