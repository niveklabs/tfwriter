...
module "aci_leaf_access_bundle_policy_group" {
  source = "./modules/aci/r/aci_leaf_access_bundle_policy_group"
...
output "description" {
  ...
  value       = aci_leaf_access_bundle_policy_group.this.description
}

output "id" {
  description = "returns a string"
  value       = aci_leaf_access_bundle_policy_group.this.id
}

output "lag_t" {
  description = "returns a string"
  value       = aci_leaf_access_bundle_policy_group.this.lag_t
}

output "name_alias" {
  description = "returns a string"
  value       = aci_leaf_access_bundle_policy_group.this.name_alias
}
