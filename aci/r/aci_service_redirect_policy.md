...
module "aci_service_redirect_policy" {
  source = "./modules/aci/r/aci_service_redirect_policy"
  ...
  relation_vns_rs_ipsla_monitoring_pol = null
...
variable "relation_vns_rs_ipsla_monitoring_pol" {
  description = "(optional)"
  type        = string
  default     = null
}
...
output "anycast_enabled" {
  ...
  value       = aci_service_redirect_policy.this.anycast_enabled
}

output "description" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.description
}

output "dest_type" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.dest_type
}

output "hashing_algorithm" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.hashing_algorithm
}

output "id" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.id
}

output "max_threshold_percent" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.max_threshold_percent
}

output "min_threshold_percent" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.min_threshold_percent
}

output "name_alias" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.name_alias
}

output "program_local_pod_only" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.program_local_pod_only
}

output "resilient_hash_enabled" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.resilient_hash_enabled
}

output "threshold_down_action" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.threshold_down_action
}

output "threshold_enable" {
  description = "returns a string"
  value       = aci_service_redirect_policy.this.threshold_enable
}
