...
module "aci_cloud_external_epg" {
  source = "./modules/aci/r/aci_cloud_external_epg"
...
output "description" {
  ...
  value       = aci_cloud_external_epg.this.description
}

output "exception_tag" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.exception_tag
}

output "flood_on_encap" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.flood_on_encap
}

output "id" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.id
}

output "match_t" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.match_t
}

output "name_alias" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.name_alias
}

output "pref_gr_memb" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.pref_gr_memb
}

output "prio" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.prio
}

output "route_reachability" {
  description = "returns a string"
  value       = aci_cloud_external_epg.this.route_reachability
}
