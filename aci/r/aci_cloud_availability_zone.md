...
module "aci_cloud_availability_zone" {
  source = "./modules/aci/r/aci_cloud_availability_zone"
...
output "description" {
  ...
  value       = aci_cloud_availability_zone.this.description
}

output "id" {
  description = "returns a string"
  value       = aci_cloud_availability_zone.this.id
}

output "name_alias" {
  description = "returns a string"
  value       = aci_cloud_availability_zone.this.name_alias
}
