...
module "aci_destination_of_redirected_traffic" {
  source = "./modules/aci/r/aci_destination_of_redirected_traffic"
  ...
  relation_vns_rs_redirect_health_group = null
...
variable "relation_vns_rs_redirect_health_group" {
  description = "(optional)"
  type        = string
  default     = null
}
...
output "description" {
  ...
  value       = aci_destination_of_redirected_traffic.this.description
}

output "dest_name" {
  description = "returns a string"
  value       = aci_destination_of_redirected_traffic.this.dest_name
}

output "id" {
  description = "returns a string"
  value       = aci_destination_of_redirected_traffic.this.id
}

output "ip2" {
  description = "returns a string"
  value       = aci_destination_of_redirected_traffic.this.ip2
}

output "name_alias" {
  description = "returns a string"
  value       = aci_destination_of_redirected_traffic.this.name_alias
}

output "pod_id" {
  description = "returns a string"
  value       = aci_destination_of_redirected_traffic.this.pod_id
}
