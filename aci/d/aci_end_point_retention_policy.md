...
module "aci_end_point_retention_policy" {
  source = "./modules/aci/d/aci_end_point_retention_policy"
...
output "bounce_age_intvl" {
  ...
  value       = data.aci_end_point_retention_policy.this.bounce_age_intvl
}

output "bounce_trig" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.bounce_trig
}

output "description" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.description
}

output "hold_intvl" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.hold_intvl
}

output "id" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.id
}

output "local_ep_age_intvl" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.local_ep_age_intvl
}

output "move_freq" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.move_freq
}

output "name_alias" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.name_alias
}

output "remote_ep_age_intvl" {
  description = "returns a string"
  value       = data.aci_end_point_retention_policy.this.remote_ep_age_intvl
}
