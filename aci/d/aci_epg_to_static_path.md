...
output "description" {
  ...
  value       = data.aci_epg_to_static_path.this.description
}

output "encap" {
  description = "returns a string"
  value       = data.aci_epg_to_static_path.this.encap
}

output "id" {
  description = "returns a string"
  value       = data.aci_epg_to_static_path.this.id
}

output "instr_imedcy" {
  description = "returns a string"
  value       = data.aci_epg_to_static_path.this.instr_imedcy
}

output "mode" {
  description = "returns a string"
  value       = data.aci_epg_to_static_path.this.mode
}

output "primary_encap" {
  description = "returns a string"
  value       = data.aci_epg_to_static_path.this.primary_encap
}
