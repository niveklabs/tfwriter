...
```terraform
data "aci_logical_node_to_fabric_node" "this" {
...
output "config_issues" {
  ...
  value       = data.aci_logical_node_to_fabric_node.this.config_issues
}

output "description" {
  description = "returns a string"
  value       = data.aci_logical_node_to_fabric_node.this.description
}

output "id" {
  description = "returns a string"
  value       = data.aci_logical_node_to_fabric_node.this.id
}

output "rtr_id" {
  description = "returns a string"
  value       = data.aci_logical_node_to_fabric_node.this.rtr_id
}

output "rtr_id_loop_back" {
  description = "returns a string"
  value       = data.aci_logical_node_to_fabric_node.this.rtr_id_loop_back
}
