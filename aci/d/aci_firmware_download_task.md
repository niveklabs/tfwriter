...
output "auth_pass" {
  ...
  value       = data.aci_firmware_download_task.this.auth_pass
}

output "auth_type" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.auth_type
}

output "description" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.description
}

output "dnld_task_flip" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.dnld_task_flip
}

output "id" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.id
}

output "identity_private_key_contents" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.identity_private_key_contents
}

output "identity_private_key_passphrase" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.identity_private_key_passphrase
}

output "identity_public_key_contents" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.identity_public_key_contents
}

output "load_catalog_if_exists_and_newer" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.load_catalog_if_exists_and_newer
}

output "name_alias" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.name_alias
}

output "password" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.password
}

output "polling_interval" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.polling_interval
}

output "proto" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.proto
}

output "url" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.url
}

output "user" {
  description = "returns a string"
  value       = data.aci_firmware_download_task.this.user
}
