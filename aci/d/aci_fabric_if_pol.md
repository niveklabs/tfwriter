...
module "aci_fabric_if_pol" {
  source = "./modules/aci/d/aci_fabric_if_pol"
...
output "auto_neg" {
  ...
  value       = data.aci_fabric_if_pol.this.auto_neg
}

output "description" {
  description = "returns a string"
  value       = data.aci_fabric_if_pol.this.description
}

output "fec_mode" {
  description = "returns a string"
  value       = data.aci_fabric_if_pol.this.fec_mode
}

output "id" {
  description = "returns a string"
  value       = data.aci_fabric_if_pol.this.id
}

output "link_debounce" {
  description = "returns a string"
  value       = data.aci_fabric_if_pol.this.link_debounce
}

output "name_alias" {
  description = "returns a string"
  value       = data.aci_fabric_if_pol.this.name_alias
}

output "speed" {
  description = "returns a string"
  value       = data.aci_fabric_if_pol.this.speed
}
