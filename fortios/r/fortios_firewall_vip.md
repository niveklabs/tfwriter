...
module "fortios_firewall_vip" {
  source = "./modules/fortios/r/fortios_firewall_vip"
...
variable "gratuitous_arp_interval" {
  description = "(optional)"
  type        = number
  default     = null
}
...
output "arp_reply" {
  ...
  value       = fortios_firewall_vip.this.arp_reply
}

output "color" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.color
}

output "dns_mapping_ttl" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.dns_mapping_ttl
}

output "extintf" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.extintf
}
...
output "extport" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.extport
}

output "fosid" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.fosid
}

output "gratuitous_arp_interval" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.gratuitous_arp_interval
}

output "http_cookie_age" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.http_cookie_age
}

output "http_cookie_domain" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.http_cookie_domain
}

output "http_cookie_domain_from_host" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.http_cookie_domain_from_host
}

output "http_cookie_generation" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.http_cookie_generation
}

output "http_cookie_path" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.http_cookie_path
}

output "http_cookie_share" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.http_cookie_share
}

output "http_ip_header" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.http_ip_header
}

output "http_ip_header_name" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.http_ip_header_name
}
...
output "ldb_method" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ldb_method
}

output "mapped_addr" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.mapped_addr
}

output "mappedport" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.mappedport
}

output "max_embryonic_connections" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.max_embryonic_connections
}
...
output "nat_source_vip" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.nat_source_vip
}

output "outlook_web_access" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.outlook_web_access
}

output "persistence" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.persistence
}

output "portforward" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.portforward
}

output "portmapping_type" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.portmapping_type
}

output "protocol" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.protocol
}

output "server_type" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.server_type
}

output "ssl_algorithm" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_algorithm
}

output "ssl_certificate" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_certificate
}
...
output "ssl_client_renegotiation" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_client_renegotiation
}

output "ssl_client_session_state_max" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.ssl_client_session_state_max
}

output "ssl_client_session_state_timeout" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.ssl_client_session_state_timeout
}

output "ssl_client_session_state_type" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_client_session_state_type
}

output "ssl_dh_bits" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_dh_bits
}

output "ssl_hpkp" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_hpkp
}

output "ssl_hpkp_age" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.ssl_hpkp_age
}

output "ssl_hpkp_backup" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_hpkp_backup
}

output "ssl_hpkp_include_subdomains" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_hpkp_include_subdomains
}

output "ssl_hpkp_primary" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_hpkp_primary
}

output "ssl_hsts" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_hsts
}

output "ssl_hsts_age" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.ssl_hsts_age
}

output "ssl_hsts_include_subdomains" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_hsts_include_subdomains
}

output "ssl_http_location_conversion" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_http_location_conversion
}

output "ssl_http_match_host" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_http_match_host
}

output "ssl_max_version" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_max_version
}

output "ssl_min_version" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_min_version
}

output "ssl_mode" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_mode
}

output "ssl_pfs" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_pfs
}

output "ssl_send_empty_frags" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_send_empty_frags
}

output "ssl_server_algorithm" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_server_algorithm
}

output "ssl_server_max_version" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_server_max_version
}

output "ssl_server_min_version" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_server_min_version
}

output "ssl_server_session_state_max" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.ssl_server_session_state_max
}

output "ssl_server_session_state_timeout" {
  description = "returns a number"
  value       = fortios_firewall_vip.this.ssl_server_session_state_timeout
}

output "ssl_server_session_state_type" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.ssl_server_session_state_type
}

output "type" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.type
}

output "uuid" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.uuid
}

output "weblogic_server" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.weblogic_server
}

output "websphere_server" {
  description = "returns a string"
  value       = fortios_firewall_vip.this.websphere_server
}
