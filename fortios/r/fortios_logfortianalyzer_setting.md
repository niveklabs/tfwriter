...
```terraform
module "fortios_logfortianalyzer_setting" {
  source = "./modules/fortios/r/fortios_logfortianalyzer_setting"
...
```terraform
resource "fortios_logfortianalyzer_setting" "this" {
  # __change_ip - (optional) is a type of number
...
output "__change_ip" {
  ...
  value       = fortios_logfortianalyzer_setting.this.__change_ip
}

output "access_config" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.access_config
}

output "certificate" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.certificate
}

output "certificate_verification" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.certificate_verification
}

output "conn_timeout" {
  description = "returns a number"
  value       = fortios_logfortianalyzer_setting.this.conn_timeout
}

output "enc_algorithm" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.enc_algorithm
}

output "faz_type" {
  description = "returns a number"
  value       = fortios_logfortianalyzer_setting.this.faz_type
}

output "hmac_algorithm" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.hmac_algorithm
}

output "id" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.id
}

output "interface" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.interface
}

output "interface_select_method" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.interface_select_method
}

output "ips_archive" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.ips_archive
}

output "max_log_rate" {
  description = "returns a number"
  value       = fortios_logfortianalyzer_setting.this.max_log_rate
}

output "mgmt_name" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.mgmt_name
}

output "monitor_failure_retry_period" {
  description = "returns a number"
  value       = fortios_logfortianalyzer_setting.this.monitor_failure_retry_period
}

output "monitor_keepalive_period" {
  description = "returns a number"
  value       = fortios_logfortianalyzer_setting.this.monitor_keepalive_period
}

output "priority" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.priority
}

output "reliable" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.reliable
}

output "server" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.server
}

output "source_ip" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.source_ip
}

output "ssl_min_proto_version" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.ssl_min_proto_version
}

output "status" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.status
}

output "upload_day" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.upload_day
}

output "upload_interval" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.upload_interval
}

output "upload_option" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.upload_option
}

output "upload_time" {
  description = "returns a string"
  value       = fortios_logfortianalyzer_setting.this.upload_time
}

output "this" {
  value = fortios_logfortianalyzer_setting.this
}
```
