...
```terraform
module "fortios_logsyslogd2_setting" {
  source = "./modules/fortios/r/fortios_logsyslogd2_setting"
...
```terraform
resource "fortios_logsyslogd2_setting" "this" {
  # certificate - (optional) is a type of string
...
output "certificate" {
  ...
  value       = fortios_logsyslogd2_setting.this.certificate
}

output "enc_algorithm" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.enc_algorithm
}

output "facility" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.facility
}

output "format" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.format
}

output "id" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.id
}

output "interface" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.interface
}

output "interface_select_method" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.interface_select_method
}

output "max_log_rate" {
  description = "returns a number"
  value       = fortios_logsyslogd2_setting.this.max_log_rate
}

output "mode" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.mode
}

output "port" {
  description = "returns a number"
  value       = fortios_logsyslogd2_setting.this.port
}

output "priority" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.priority
}

output "server" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.server
}

output "source_ip" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.source_ip
}

output "ssl_min_proto_version" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.ssl_min_proto_version
}

output "status" {
  description = "returns a string"
  value       = fortios_logsyslogd2_setting.this.status
}

output "syslog_type" {
  description = "returns a number"
  value       = fortios_logsyslogd2_setting.this.syslog_type
}

output "this" {
  value = fortios_logsyslogd2_setting.this
}
```
