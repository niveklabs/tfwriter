...
```terraform
module "fortios_logfortiguard_overridefilter" {
  source = "./modules/fortios/r/fortios_logfortiguard_overridefilter"
...
```terraform
resource "fortios_logfortiguard_overridefilter" "this" {
  anomaly               = var.anomaly
...
output "anomaly" {
  ...
  value       = fortios_logfortiguard_overridefilter.this.anomaly
}

output "dlp_archive" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.dlp_archive
}

output "dns" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.dns
}

output "filter" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.filter
}

output "filter_type" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.filter_type
}

output "forward_traffic" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.forward_traffic
}

output "gtp" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.gtp
}

output "id" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.id
}

output "local_traffic" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.local_traffic
}

output "multicast_traffic" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.multicast_traffic
}

output "netscan_discovery" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.netscan_discovery
}

output "netscan_vulnerability" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.netscan_vulnerability
}

output "severity" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.severity
}

output "sniffer_traffic" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.sniffer_traffic
}

output "ssh" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.ssh
}

output "voip" {
  description = "returns a string"
  value       = fortios_logfortiguard_overridefilter.this.voip
}

output "this" {
  value = fortios_logfortiguard_overridefilter.this
}
```
