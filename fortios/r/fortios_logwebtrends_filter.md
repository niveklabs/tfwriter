...
```terraform
module "fortios_logwebtrends_filter" {
  source = "./modules/fortios/r/fortios_logwebtrends_filter"
...
```terraform
resource "fortios_logwebtrends_filter" "this" {
  # anomaly - (optional) is a type of string
  anomaly = var.anomaly
  # dns - (optional) is a type of string
  dns = var.dns
...
output "anomaly" {
  ...
  value       = fortios_logwebtrends_filter.this.anomaly
}

output "dns" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.dns
}

output "filter" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.filter
}

output "filter_type" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.filter_type
}

output "forward_traffic" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.forward_traffic
}

output "gtp" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.gtp
}

output "id" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.id
}

output "local_traffic" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.local_traffic
}

output "multicast_traffic" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.multicast_traffic
}

output "netscan_discovery" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.netscan_discovery
}

output "netscan_vulnerability" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.netscan_vulnerability
}

output "severity" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.severity
}

output "sniffer_traffic" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.sniffer_traffic
}

output "ssh" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.ssh
}

output "voip" {
  description = "returns a string"
  value       = fortios_logwebtrends_filter.this.voip
}

output "this" {
  value = fortios_logwebtrends_filter.this
}
```
