...
```terraform
module "fortios_emailfilter_bwl" {
  source = "./modules/fortios/r/fortios_emailfilter_bwl"
...
```terraform
resource "fortios_emailfilter_bwl" "this" {
  # comment - (optional) is a type of string
  comment = var.comment
  # dynamic_sort_subtable - (optional) is a type of string
...
output "fosid" {
  ...
  value       = fortios_emailfilter_bwl.this.fosid
}

output "id" {
  description = "returns a string"
  value       = fortios_emailfilter_bwl.this.id
}

output "name" {
  description = "returns a string"
  value       = fortios_emailfilter_bwl.this.name
}

output "this" {
  value = fortios_emailfilter_bwl.this
}
```
