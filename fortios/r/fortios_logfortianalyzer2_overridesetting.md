...
module "fortios_logfortianalyzer2_overridesetting" {
  source = "./modules/fortios/r/fortios_logfortianalyzer2_overridesetting"
...
output "__change_ip" {
  ...
  value       = fortios_logfortianalyzer2_overridesetting.this.__change_ip
}

output "access_config" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.access_config
}

output "certificate" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.certificate
}

output "certificate_verification" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.certificate_verification
}

output "conn_timeout" {
  description = "returns a number"
  value       = fortios_logfortianalyzer2_overridesetting.this.conn_timeout
}

output "enc_algorithm" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.enc_algorithm
}

output "faz_type" {
  description = "returns a number"
  value       = fortios_logfortianalyzer2_overridesetting.this.faz_type
}

output "hmac_algorithm" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.hmac_algorithm
}

output "id" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.id
}

output "interface" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.interface
}

output "interface_select_method" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.interface_select_method
}

output "ips_archive" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.ips_archive
}

output "max_log_rate" {
  description = "returns a number"
  value       = fortios_logfortianalyzer2_overridesetting.this.max_log_rate
}

output "mgmt_name" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.mgmt_name
}

output "monitor_failure_retry_period" {
  description = "returns a number"
  value       = fortios_logfortianalyzer2_overridesetting.this.monitor_failure_retry_period
}

output "monitor_keepalive_period" {
  description = "returns a number"
  value       = fortios_logfortianalyzer2_overridesetting.this.monitor_keepalive_period
}

output "override" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.override
}

output "priority" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.priority
}

output "reliable" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.reliable
}

output "server" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.server
}

output "source_ip" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.source_ip
}

output "ssl_min_proto_version" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.ssl_min_proto_version
}

output "status" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.status
}

output "upload_day" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.upload_day
}

output "upload_interval" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.upload_interval
}

output "upload_option" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.upload_option
}

output "upload_time" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.upload_time
}

output "use_management_vdom" {
  description = "returns a string"
  value       = fortios_logfortianalyzer2_overridesetting.this.use_management_vdom
}

output "this" {
  value = fortios_logfortianalyzer2_overridesetting.this
}
```
