...
output "access_config" {
  ...
  value       = fortios_logfortianalyzer3_overridesetting.this.access_config
}
...
output "certificate_verification" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_overridesetting.this.certificate_verification
}
...
output "interface" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_overridesetting.this.interface
}

output "interface_select_method" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_overridesetting.this.interface_select_method
}
...
output "max_log_rate" {
  description = "returns a number"
  value       = fortios_logfortianalyzer3_overridesetting.this.max_log_rate
}
...
output "priority" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_overridesetting.this.priority
}
