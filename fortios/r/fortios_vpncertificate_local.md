...
output "auto_regenerate_days" {
  ...
  value       = fortios_vpncertificate_local.this.auto_regenerate_days
}

output "auto_regenerate_days_warning" {
  description = "returns a number"
  value       = fortios_vpncertificate_local.this.auto_regenerate_days_warning
}

output "ca_identifier" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.ca_identifier
}

output "certificate" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.certificate
}

output "cmp_path" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.cmp_path
}

output "cmp_regeneration_method" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.cmp_regeneration_method
}

output "cmp_server" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.cmp_server
}

output "cmp_server_cert" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.cmp_server_cert
}

output "comments" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.comments
}

output "csr" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.csr
}

output "enroll_protocol" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.enroll_protocol
}
...
output "ike_localid" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.ike_localid
}

output "ike_localid_type" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.ike_localid_type
}

output "last_updated" {
  description = "returns a number"
  value       = fortios_vpncertificate_local.this.last_updated
}

output "name_encoding" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.name_encoding
}

output "range" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.range
}

output "scep_url" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.scep_url
}

output "source" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.source
}

output "source_ip" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.source_ip
}

output "state" {
  description = "returns a string"
  value       = fortios_vpncertificate_local.this.state
}

output "this" {
  value = fortios_vpncertificate_local.this
}
```
