...
```terraform
module "fortios_logfortianalyzer3_setting" {
  source = "./modules/fortios/r/fortios_logfortianalyzer3_setting"
...
output "conn_timeout" {
  description = "returns a number"
  value       = fortios_logfortianalyzer3_setting.this.conn_timeout
}

output "enc_algorithm" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.enc_algorithm
}

output "faz_type" {
  description = "returns a number"
  value       = fortios_logfortianalyzer3_setting.this.faz_type
}

output "hmac_algorithm" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.hmac_algorithm
}
...
output "mgmt_name" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.mgmt_name
}

output "monitor_failure_retry_period" {
  description = "returns a number"
  value       = fortios_logfortianalyzer3_setting.this.monitor_failure_retry_period
}
...
output "reliable" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.reliable
}

output "server" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.server
}

output "source_ip" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.source_ip
}

output "ssl_min_proto_version" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.ssl_min_proto_version
}

output "status" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.status
}

output "upload_day" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.upload_day
}

output "upload_interval" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.upload_interval
}

output "upload_option" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.upload_option
}

output "upload_time" {
  description = "returns a string"
  value       = fortios_logfortianalyzer3_setting.this.upload_time
}

output "this" {
  value = fortios_logfortianalyzer3_setting.this
}
```
