...
```terraform
module "fortios_vpncertificate_crl" {
  source = null
...
```terraform
resource "fortios_vpncertificate_crl" "this" {
  # crl - (optional) is a type of string
  crl = var.crl
  # http_url - (optional) is a type of string
...
output "crl" {
  ...
  value       = fortios_vpncertificate_crl.this.crl
}

output "http_url" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.http_url
}

output "id" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.id
}

output "last_updated" {
  description = "returns a number"
  value       = fortios_vpncertificate_crl.this.last_updated
}

output "ldap_server" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.ldap_server
}

output "ldap_username" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.ldap_username
}

output "range" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.range
}

output "scep_cert" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.scep_cert
}

output "scep_url" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.scep_url
}

output "source" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.source
}

output "source_ip" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.source_ip
}

output "update_interval" {
  description = "returns a number"
  value       = fortios_vpncertificate_crl.this.update_interval
}

output "update_vdom" {
  description = "returns a string"
  value       = fortios_vpncertificate_crl.this.update_vdom
}

output "this" {
  value = fortios_vpncertificate_crl.this
}
```
