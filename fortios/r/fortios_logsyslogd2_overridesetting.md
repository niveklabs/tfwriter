...
```terraform
module "fortios_logsyslogd2_overridesetting" {
  source = "./modules/fortios/r/fortios_logsyslogd2_overridesetting"
...
output "certificate" {
  ...
  value       = fortios_logsyslogd2_overridesetting.this.certificate
}

output "enc_algorithm" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.enc_algorithm
}

output "facility" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.facility
}

output "format" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.format
}
...
output "override" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.override
}
...
output "server" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.server
}

output "source_ip" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.source_ip
}

output "ssl_min_proto_version" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.ssl_min_proto_version
}

output "status" {
  description = "returns a string"
  value       = fortios_logsyslogd2_overridesetting.this.status
}

output "syslog_type" {
  description = "returns a number"
  value       = fortios_logsyslogd2_overridesetting.this.syslog_type
}

output "this" {
  value = fortios_logsyslogd2_overridesetting.this
}
```
