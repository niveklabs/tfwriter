...
```terraform
module "fortios_logmemory_filter" {
  source = "./modules/fortios/r/fortios_logmemory_filter"
...
```terraform
resource "fortios_logmemory_filter" "this" {
  admin                 = var.admin
  anomaly               = var.anomaly
  auth                  = var.auth
...
output "admin" {
  ...
  value       = fortios_logmemory_filter.this.admin
}

output "anomaly" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.anomaly
}

output "auth" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.auth
}

output "cpu_memory_usage" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.cpu_memory_usage
}

output "dhcp" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.dhcp
}

output "dns" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.dns
}

output "event" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.event
}

output "filter" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.filter
}

output "filter_type" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.filter_type
}

output "forward_traffic" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.forward_traffic
}

output "gtp" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.gtp
}

output "ha" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.ha
}

output "id" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.id
}

output "ipsec" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.ipsec
}

output "ldb_monitor" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.ldb_monitor
}

output "local_traffic" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.local_traffic
}

output "multicast_traffic" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.multicast_traffic
}

output "netscan_discovery" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.netscan_discovery
}

output "netscan_vulnerability" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.netscan_vulnerability
}

output "pattern" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.pattern
}

output "ppp" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.ppp
}

output "radius" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.radius
}

output "severity" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.severity
}

output "sniffer_traffic" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.sniffer_traffic
}

output "ssh" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.ssh
}

output "sslvpn_log_adm" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.sslvpn_log_adm
}

output "sslvpn_log_auth" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.sslvpn_log_auth
}

output "sslvpn_log_session" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.sslvpn_log_session
}

output "system" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.system
}

output "vip_ssl" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.vip_ssl
}

output "voip" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.voip
}

output "wan_opt" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.wan_opt
}

output "wireless_activity" {
  description = "returns a string"
  value       = fortios_logmemory_filter.this.wireless_activity
}

output "this" {
  value = fortios_logmemory_filter.this
}
```
