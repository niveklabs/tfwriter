...
module "vcd_network_isolated" {
  source = "./modules/vcd/r/vcd_network_isolated"
...
variable "gateway" {
  description = "(optional) - The gateway for this network"
  type        = string
  default     = null
}
...
```terraform
resource "vcd_network_isolated" "this" {
  # description - (optional) is a type of string
...
output "href" {
  ...
  value       = vcd_network_isolated.this.href
}

output "id" {
  description = "returns a string"
  value       = vcd_network_isolated.this.id
}
