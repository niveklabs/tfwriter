...
output "computer_name" {
  ...
  value       = vcd_vm.this.computer_name
}

output "cpu_cores" {
  description = "returns a number"
  value       = vcd_vm.this.cpu_cores
}

output "cpus" {
  description = "returns a number"
  value       = vcd_vm.this.cpus
}

output "description" {
  description = "returns a string"
  value       = vcd_vm.this.description
}

output "hardware_version" {
  description = "returns a string"
  value       = vcd_vm.this.hardware_version
}

output "href" {
  description = "returns a string"
  value       = vcd_vm.this.href
}

output "id" {
  description = "returns a string"
  value       = vcd_vm.this.id
}

output "internal_disk" {
  description = "returns a list of object"
  value       = vcd_vm.this.internal_disk
}

output "memory" {
  description = "returns a number"
  value       = vcd_vm.this.memory
}

output "os_type" {
  description = "returns a string"
  value       = vcd_vm.this.os_type
}

output "sizing_policy_id" {
  description = "returns a string"
  value       = vcd_vm.this.sizing_policy_id
}

output "storage_profile" {
  description = "returns a string"
  value       = vcd_vm.this.storage_profile
}

output "vapp_name" {
  description = "returns a string"
  value       = vcd_vm.this.vapp_name
}

output "vm_type" {
  description = "returns a string"
  value       = vcd_vm.this.vm_type
}
